...
#define SCSI_KCQIR_PARMLISTLENGTHERROR          0x051a00 /* Illegal Request - param list length error */
...
#define SCSI_KCQIR_INVALIDFIELDSINPARMLIST      0x052600 /* Illegal Request - invalid fields in param list */
#define SCSI_KCQIR_PARAMETERNOTSUPPORTED        0x052601 /* Illegal Request - parameter not supported */
#define SCSI_KCQIR_INVALIDPARMVALUE             0x052602 /* Illegal Request - invalid param value */
...
#define SCSI_KCQIR_SAVINGPARAMSNOTSUPPORTED     0x053900 /* Illegal Request - Saving parameters not supported */
...
#define SCSI_KCQUA_LOGSELECTPARAMSCHANGED     0x062a02 /* Unit Attention - log select params changed */
...
/* SSCSI Status Codes *******************************************************/
#define SCSI_STATUS_OK                       0x00 /* USB_OK */
...
#define SCIRESP_RDFMTCAPACITIES_UNFORMATTED 0x01 /* Unformatted media */
#define SCIRESP_RDFMTCAPACITIES_FORMATTED   0x02 /* Formatted media */
