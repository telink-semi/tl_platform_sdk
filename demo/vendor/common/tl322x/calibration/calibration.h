...
#if defined(MCU_STARTUP_NVM)

#ifndef MCU_CALIB_USE_NVM
    #define MCU_CALIB_USE_NVM       1
#endif

#else

#ifndef MCU_CALIB_USE_NVM
    #define MCU_CALIB_USE_NVM       0
#endif

#endif

/*************************************** NVM calibration data offset definition ***************************************/
#ifndef NVM_CAP_VALUE_ADDR_512K
    #define NVM_CAP_VALUE_ADDR_512K 0x7e000
#endif

#ifndef NVM_IEEE_ADDR_LOCATION_512K
    #define NVM_IEEE_ADDR_LOCATION_512K 0x7f000
#endif

/*************************************** flash calibration data offset definition ***************************************/
