 ...
 */
    ...
    #elif defined(MCU_CORE_TL321X) || defined(MCU_CORE_TL751X) || defined(MCU_CORE_TL322X) || defined(MCU_CORE_TL323X) || defined(MCU_CORE_TL521X) || defined(MCU_CORE_TL523X)|| defined(MCU_CORE_TL522X)
 ...
 * Do not recommended that two or more GPIOs be set to the same interrupt source, as the interrupt is uncertain if triggered at the same time.
 */
        #define GPIO_MODE     GPIO_IRQ_NUM0
    #endif
