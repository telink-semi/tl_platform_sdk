...
//only the slave can support llp mode, the master cannot.
    ...
    #elif defined(MCU_CORE_TL7518) || defined(MCU_CORE_TL721X) || defined(MCU_CORE_TL321X) || defined(MCU_CORE_TL322X) || defined(MCU_CORE_TL323X) || defined(MCU_CORE_TL521X) || defined(MCU_CORE_TL522X) || defined(MCU_CORE_TL751X) || defined(MCU_CORE_TL753X) || defined(MCU_CORE_TL711X)
...
void user_init(void)
{
    ...
    #elif (defined(MCU_CORE_TL7518) || defined(MCU_CORE_TL322X) || defined(MCU_CORE_TL323X) || defined(MCU_CORE_TL521X) || defined(MCU_CORE_TL522X) || defined(MCU_CORE_TL751X) || defined(MCU_CORE_TL753X) || defined(MCU_CORE_TL711X)) && (UART_MODULE_SEL == UART2_MODULE)
    uart_set_pin(UART_MODULE_SEL, UART2_TX_PIN, UART2_RX_PIN);
    #elif (defined(MCU_CORE_TL7518) || defined(MCU_CORE_TL322X) || defined(MCU_CORE_TL323X) || defined(MCU_CORE_TL521X) || defined(MCU_CORE_TL522X) || defined(MCU_CORE_TL751X) || defined(MCU_CORE_TL753X) || defined(MCU_CORE_TL711X)) && (UART_MODULE_SEL == UART3_MODULE)
    ...
    #elif (defined(MCU_CORE_TL721X) || defined(MCU_CORE_TL321X) || defined(MCU_CORE_TL751X) || defined(MCU_CORE_TL753X) || defined(MCU_CORE_TL711X)) && (UART_MODULE_SEL == UART2_MODULE)
    uart_set_pin(UART_MODULE_SEL, UART2_TX_PIN, UART2_RX_PIN);
    #endif
