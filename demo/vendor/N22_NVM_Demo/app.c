...
#define NVM_ADDR                0x010880
#define NVM_CR_OTP_ADDR         0x085880
#define NVM_CC_OTP_ADDR         0x086180
...
void nvm_ahb_read(void)
{
    ...
    nvm_ahb1_read_word(NVM_ADDR, NVM_BUFF_LEN, nvm_read_buff4);
    ...
    nvm_ahb1_read_byte(NVM_ADDR, 1, nvm_read_buff);
    nvm_ahb1_read_byte(NVM_ADDR + 1, NVM_BUFF_LEN - 1, &nvm_read_buff[1]);
    ...
    nvm_ahb1_read_byte(NVM_CR_OTP_ADDR, 1, nvm_read_buff);
    nvm_ahb1_read_byte(NVM_CR_OTP_ADDR + 1, NVM_BUFF_LEN - 1, &nvm_read_buff[1]);
    if (nvm_compare((unsigned int *)nvm_read_buff, nvm_write_buff4, NVM_BUFF_LEN / 4))
    {
    ...
    nvm_reg_bypass_cache();
    nvm_ahb1_read_word(NVM_CR_OTP_ADDR, NVM_BUFF_LEN, nvm_read_buff4);
    if (nvm_compare(nvm_read_buff4, nvm_write_buff4, NVM_BUFF_LEN / 4))
    {
    ...
    nvm_ahb1_read_byte(NVM_CC_OTP_ADDR, 1, nvm_read_buff);
    nvm_ahb1_read_byte(NVM_CC_OTP_ADDR + 1, NVM_BUFF_LEN / 2 - 1, &nvm_read_buff[1]);
    ...
    nvm_reg_bypass_cache();
    nvm_ahb1_read_word(NVM_CC_OTP_ADDR, NVM_BUFF_LEN / 2, nvm_read_buff4);
