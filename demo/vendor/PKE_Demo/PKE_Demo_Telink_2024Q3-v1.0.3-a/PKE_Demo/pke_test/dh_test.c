...
unsigned int dh_test_internal(DH_PARA *dh_para, unsigned char *local_prikey, unsigned char *local_pubkey, unsigned char *peer_prikey, unsigned char *peer_pubkey, unsigned char *std_key, char *info)
{
...
unsigned int dh_static_1024_160_std_test(void)
{
    ...
    unsigned int  i, ret;
    DH_PARA       dh_para_array[1];
    DH_PARA      *dh_para = dh_para_array;
