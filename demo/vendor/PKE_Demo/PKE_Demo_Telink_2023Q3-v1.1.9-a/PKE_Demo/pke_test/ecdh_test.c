...
unsigned int ecdh_std_test_secp160k1(void)
{
    ...
    ret = ecdh_test_internal(secp160k1, "secp160k1", local_prikey, local_pubkey, peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if (ret) {
        return 1;
    }
...
unsigned int ecdh_std_test_secp192k1(void)
{
    ...
    ret = ecdh_test_internal(secp192k1, "secp192k1", local_prikey, local_pubkey, peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if (ret) {
        return 1;
    }
...
unsigned int ecdh_std_test_secp224k1(void)
{
    ...
    ret = ecdh_test_internal(secp224k1, "secp224k1", local_prikey, local_pubkey, peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if (ret) {
        return 1;
    }
...
unsigned int ecdh_std_test_secp256k1(void)
{
    ...
    ret = ecdh_test_internal(secp256k1, "secp256k1", local_prikey, local_pubkey, peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if (ret) {
        return 1;
    }
...
unsigned int ecdh_std_test_secp160r1(void)
{
    ...
    ret = ecdh_test_internal(secp160r1, "secp160r1", local_prikey, local_pubkey, peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if (ret) {
        return 1;
    }
...
unsigned int ecdh_std_test_secp160r2(void)
{
    ...
    ret = ecdh_test_internal(secp160r2, "secp160r2", local_prikey, local_pubkey, peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if (ret) {
        return 1;
    }
...
unsigned int ecdh_std_test_brainpoolp256r1(void)
{
    ...
    ret = ecdh_test_internal(brainpoolp256r1, "brainpoolp256r1", local_prikey, local_pubkey, peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if (ret) {
        return 1;
    }
...
unsigned int ecdh_std_test_anders_1024_1(void)
{
    ...
    ret = ecdh_test_internal(anders_1024_1, "anders_1024_1", local_prikey, local_pubkey, peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if (ret) {
        return 1;
    }
