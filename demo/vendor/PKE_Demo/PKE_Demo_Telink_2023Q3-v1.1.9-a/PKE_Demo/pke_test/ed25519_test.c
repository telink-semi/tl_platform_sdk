...
//        {;}
        ...
        if(EdDSA_SUCCESS != ret)
        {
            printf("\r\n Ed25519 test %u sign error(Ed25519_PH), ret = %x", index, ret); fflush(stdout);
    ...
    if(Ed25519_PH == mode)
    {
        ...
        if(EdDSA_SUCCESS != ret)
        {
            printf("  verify fail(PH_WITH_PH_M), ret = %x", ret);fflush(stdout);
            return 1;
        }
    }
...
unsigned int ed25519_speed_test(void)
{
    ...
    endP(1,0,round);
#else
    printf("\r\n get key finished");fflush(stdout);
#endif
    ...
    endP(1,0,round);
#else
    printf("\r\n point mul finished");fflush(stdout);
#endif



    printf("\r\n ============= Ed25519 sign begin =============");fflush(stdout);
    ...
    endP(1,0,round);
#else
    printf("\r\n Ed25519 sign finished");fflush(stdout);
#endif


    printf("\r\n ============= Ed25519 verify begin =============");fflush(stdout);
    ...
    endP(1,0,round);
#else
    printf("\r\n Ed25519 verify finished");fflush(stdout);
#endif
