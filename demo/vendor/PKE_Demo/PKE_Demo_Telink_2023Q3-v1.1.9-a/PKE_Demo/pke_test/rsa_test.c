...
unsigned int rsa_modexp_sample_test_internal(RSA_MODEXP_SAMPLE_TEST_VECTOR *vector)
{
    ...
    printf("\r\n\r\n --------------------- RSA-%u modexp sample test ---------------------- ", nBitLen);fflush(stdout);
    ...
    for(i=0; i<2; i++)
    {
        ...
        {
            printf("\r\n RSA-%u MOD_EXP test failure, ret=%x", nBitLen, ret);fflush(stdout);
        ...
        {
            printf("\r\n RSA-%u MOD_EXP test success", nBitLen);fflush(stdout);
        }
        ...
        if((RSA_SUCCESS != ret) || (uint32_BigNumCmp(out, wordLen, vector->std_out, wordLen) != 0))
        {
            printf("\r\n RSA-%u CRT_MOD_EXP test failure, ret=%x", nBitLen, ret);fflush(stdout);
        ...
        {
            printf("\r\n RSA-%u CRT_MOD_EXP test success", nBitLen);fflush(stdout);
        }
...
unsigned int rsa_modexp_speed_test_internal(RSA_MODEXP_SAMPLE_TEST_VECTOR *vector)
{
    ...
    memset_((unsigned char *)out, 0, wordLen<<2);
    counter = counter_1;
    printf("\r\n ======== RSA-%u RSA_ModExp test(e %u bits) begin ========", nBitLen, eBitLen);fflush(stdout);
    ...
    {
        printf("\r\n RSA-%u RSA_ModExp test(e %u bits) failure, ret=%x", nBitLen, eBitLen, ret);fflush(stdout);
    ...
    memset_((unsigned char *)out, 0, wordLen<<2);
    counter = counter_2;
    printf("\r\n ======== RSA-%u RSA_ModExp test(d %u bits) begin ========", nBitLen, nBitLen);fflush(stdout);
    ...
    if((RSA_SUCCESS != ret) || (uint32_BigNumCmp(out, wordLen, vector->std_out, wordLen) != 0))
    {
        printf("\r\n RSA-%u RSA_ModExp test(d %u bits) failure, ret=%x", nBitLen, nBitLen, ret);fflush(stdout);
    ...
    memset_((unsigned char *)out, 0, wordLen<<2);
    counter = counter_2;
    printf("\r\n ======== RSA-%u RSA_ModExp_with_pub test(d %u bits) begin ========", nBitLen, nBitLen);fflush(stdout);
    ...
    {
        printf("\r\n RSA-%u RSA_ModExp_with_pub test(d %u bits) failure, ret=%x", nBitLen, nBitLen, ret);fflush(stdout);
        print_BN_buf_U32(vector->std_out, wordLen, "vector->std_out");
        print_BN_buf_U32(out, wordLen, "out");
        return 1;
    }
    ...
    memset_((unsigned char *)out, 0, wordLen<<2);
    counter = counter_3;
    printf("\r\n ======== RSA-%u RSA_CRTModExp test begin ========", nBitLen);fflush(stdout);
    ...
    if((RSA_SUCCESS != ret) || (uint32_BigNumCmp(out, wordLen, vector->std_out, wordLen) != 0))
    {
        printf("\r\n RSA-%u RSA_CRTModExp test failure, ret=%x", nBitLen, ret);fflush(stdout);
        print_BN_buf_U32(vector->std_out, wordLen, "vector->std_out");
        print_BN_buf_U32(out, wordLen, "out");
        return 1;
    }
    ...
    memset_((unsigned char *)out, 0, wordLen<<2);
    counter = counter_4;
    printf("\r\n ======== RSA-%u RSA_CRTModExp_with_pub test begin ========", nBitLen);fflush(stdout);
    ...
    if((RSA_SUCCESS_S != ret) || (uint32_BigNumCmp(out, wordLen, vector->std_out, wordLen) != 0))
    {
        printf("\r\n RSA-%u RSA_CRTModExp_with_pub test failure, ret=%x", nBitLen, ret);fflush(stdout);
        print_BN_buf_U32(vector->std_out, wordLen, "vector->std_out");
        print_BN_buf_U32(out, wordLen, "out");
        return 1;
    }
...
unsigned int rsa_get_key_speed_test(unsigned int is_for_crt, unsigned int round, unsigned int eBitLen, unsigned int nBitLen)
{
    ...
    if(is_for_crt)
    {
        for(i=0; i<round; i++)
        {
            ...
            if(RSA_SUCCESS != ret)
            {
                printf("\r\n RSA_GetCRTKey failure, ret = %x", ret);fflush(stdout);
                return 1;
            }

            if((i+1)%count == 0)
            {
                printf("\r\n RSA-CRT%u %u", nBitLen, i+1);fflush(stdout);
            }
        }
    }
    else
    {
        for(i=0; i<round; i++)
        {
            ...
            if(RSA_SUCCESS != ret)
            {
                printf("\r\n RSA_GetKey failure, ret = %x", ret);fflush(stdout);
                return 1;
            }

            if((i+1)%count == 0)
            {
                printf("\r\n RSA%u %u", nBitLen, i+1);fflush(stdout);
            }
        }
    }
...
unsigned int rsa_get_key_traversal_test(void)
{
    ...
    for(nBitLen=1024; nBitLen<=4096; nBitLen+=2)//for(nBitLen=1024; nBitLen<=2048; nBitLen+=2)
    {
        ...
        printf("\r\n nBitLen = %u", nBitLen);fflush(stdout);
    }
...
unsigned int rsa_get_crt_key_traversal_test(void)
{
    ...
    for(nBitLen=1024; nBitLen<=4096; nBitLen+=2)
    {
        ...
        printf("\r\n CRT nBitLen = %u", nBitLen);fflush(stdout);
    }
...
//}printf("\r\n end     ");fflush(stdout);
        if(RSA_SUCCESS != ret)
        {
            printf("\r\n RSA_ModExp error 1, ret = %x", ret);fflush(stdout);
            return 1;
        }
...
//}printf("\r\n end     ");fflush(stdout);
        if(RSA_SUCCESS != ret)
        {
            printf("\r\n RSA_ModExp error 2, ret = %x", ret);fflush(stdout);
            return 1;
        }

        if(uint32_BigNumCmp(out2, nWordLen, in, nWordLen) != 0)
        {
            printf("\r\n RSA encrypt & decrypt error");fflush(stdout);
        ...
        if(RSA_SUCCESS == ret)
        {
            printf("\r\n RSA_ModExp corner test 1 error, ret = %x", ret);fflush(stdout);
            return 1;
        }
        ...
        {
            printf("\r\n RSA_ModExp corner test 2 error, ret = %x", ret);fflush(stdout);
            return 1;
        }
...
//}printf("\r\n end     ");fflush(stdout);
        if(RSA_SUCCESS != ret)
        {
            printf("\r\n RSA_CRTModExp error 2, ret = %x", ret);fflush(stdout);
            return 1;
        }

        if(uint32_BigNumCmp(out2, nWordLen, in, nWordLen) != 0)
        {
            printf("\r\n RSA CRT encrypt & decrypt error");fflush(stdout);
            print_BN_buf_U32(in, nWordLen, "in");
            print_BN_buf_U32(out, nWordLen, "out");
            print_BN_buf_U32(out2, nWordLen, "out2");
            print_BN_buf_U32(e, eWordLen, "e");
        ...
        {
            printf("\r\n RSA_CRTModExp corner test 1 error, ret = %x", ret);fflush(stdout);
            return 1;
        }
        ...
        {
            printf("\r\n RSA_CRTModExp corner test 2 error, ret = %x", ret);fflush(stdout);
        ...
        {
            printf("\r\n RSA_CRTModExp corner test 3 error, ret = %x", ret);fflush(stdout);
            return 1;
        }
        ...
        if((RSA_SUCCESS != ret) || (0 != uint32_BigNumCmp(out2, nWordLen, in, nWordLen)))
        {
            printf("\r\n RSA_CRTModExp corner test 4 error, ret = %x", ret);fflush(stdout);
            return 1;
        }
        ...
        if((RSA_SUCCESS != ret) || (0 != uint32_BigNumCmp(out, nWordLen, in, nWordLen)))
        {
            printf("\r\n RSA_CRTModExp corner test 5 error, ret = %x", ret);fflush(stdout);
            return 1;
        }
        ...
        if((RSA_SUCCESS != ret) || (1u != uint32_BigNum_Check_Zero(out, nWordLen)))
        {
            printf("\r\n RSA_CRTModExp corner test 6 error, ret = %x", ret);fflush(stdout);
            return 1;
        }
#endif
        //if((i+1)%50 == 0)
