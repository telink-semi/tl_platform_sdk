...
unsigned int ecdh_std_test_anders_1024_1(void)
{
    ...
    unsigned char peer_pubkey[256]={
            ,
    };

    unsigned char std_key[128]={
            ,
    };
    unsigned int keyByteLen = 128;
    unsigned int ret;

    ret = ecdh_test_internal(anders_1024_1, "anders_1024_1", local_prikey, local_pubkey,
            peer_prikey, peer_pubkey, std_key, keyByteLen, NULL);
    if(ret)
        return 1;
...
unsigned int ecdh_speed_test(eccp_curve_t *curve, char *curve_name)
{
    unsigned char local_prikey[ECCP_MAX_BYTE_LEN];
    unsigned char local_pubkey[2*ECCP_MAX_BYTE_LEN];
    unsigned char peer_prikey[ECCP_MAX_BYTE_LEN];
    ...
    ret = 0;
    printf("\r\n ======== ecdh_compute_key begin ======== ");fflush(stdout);
