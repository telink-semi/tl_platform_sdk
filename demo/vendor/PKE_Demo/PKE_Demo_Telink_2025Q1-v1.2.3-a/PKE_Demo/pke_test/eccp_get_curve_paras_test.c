...
/**
 * @brief           Test the retrieval of curve parameters for the brainpoolp256r1 curve
...
unsigned int brainpoolp256r1_get_curve_paras_test(void)
{
    ...
    ret = pke_pre_calc_mont((const unsigned int *)brainpoolp256r1_p, 256, brainpoolp256r1_p_h, brainpoolp256r1_p_n0);
    if ((PKE_SUCCESS != ret) || (uint32_big_num_cmp(brainpoolp256r1_p_h, 8, std_brainpoolp256r1_p_h, 8) != 0) || (brainpoolp256r1_p_n0[0] != std_brainpoolp256r1_p_n0[0])) {
        printf("\r\n get p_h error");
        print_bn_buf_u32(brainpoolp256r1_p_h, 8, "p_h");
        return 1;
    }

    ret = pke_pre_calc_mont((const unsigned int *)brainpoolp256r1_n, 256, brainpoolp256r1_n_h, brainpoolp256r1_n_n0);
    if ((PKE_SUCCESS != ret) || (uint32_big_num_cmp(brainpoolp256r1_n_h, 8, std_brainpoolp256r1_n_h, 8) != 0) || (brainpoolp256r1_n_n0[0] != std_brainpoolp256r1_n_n0[0])) {
        printf("\r\n get n_h error");
