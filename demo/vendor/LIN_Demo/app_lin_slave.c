...
#if (LIN_TEST_MODE == LIN_TEST_SLAVE)
...
lin_frame_item_t s_frame_list[] = {
    {LIN_ACTION_TX, 0x01, 1, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_TX, 0x02, 2, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_TX, 0x03, 3, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_TX, 0x04, 4, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_TX, 0x05, 5, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_TX, 0x06, 6, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_TX, 0x07, 7, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_TX, 0x08, 8, {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},

    {LIN_ACTION_RX, 0x11, 1, {0x00}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_RX, 0x12, 2, {0x00}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_RX, 0x13, 3, {0x00}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_RX, 0x14, 4, {0x00}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_RX, 0x15, 5, {0x00}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_RX, 0x16, 6, {0x00}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_RX, 0x17, 7, {0x00}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
    {LIN_ACTION_RX, 0x18, 8, {0x00}, LIN_CHECKSUM_TYPE_ENHANCED, 0, 0, 0},
};
...
void user_init(void)
{
    ...
    lin_set_irq_mask(s_handle, FLD_LIN_MASK_RESP_TX_DONE_RW | FLD_LIN_MASK_RESP_RX_DONE_RW | FLD_LIN_MASK_RESP_TIMEOUT_RW | FLD_LIN_MASK_HEADER_TIMEOUT_RW | FLD_LIN_MASK_RESP_CHECKSUM_ERR_RW | FLD_LIN_MASK_REC_HEADER_RW | FLD_LIN_MASK_REC_HEADER_ERR_RW | FLD_LIN_MASK_REC_NEW_BREAK_RW);
