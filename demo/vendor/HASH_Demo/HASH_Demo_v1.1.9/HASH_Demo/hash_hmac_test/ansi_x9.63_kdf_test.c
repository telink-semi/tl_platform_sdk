...
unsigned int ansi_x9_63_kdf_test_internal(HASH_ALG hash_alg, unsigned char *std_Z, unsigned int Z_bytes, unsigned char *std_shared_info, unsigned int shared_info_bytes, unsigned char *std_k, unsigned int k_bytes, char *info)
{
