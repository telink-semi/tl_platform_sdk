...
unsigned int hmac_test(HASH_ALG hash_alg, unsigned char *std_mac1, unsigned char *std_mac2, unsigned char *std_mac3,
        unsigned char *std_mac4, unsigned char *std_mac5, unsigned char *std_mac6)
{
    HMAC_CTX ctx[1];
        ...
        unsigned char *std_mac4, unsigned char *std_mac5)
{
    ...
    {
        printf("\r\n %s DMA test 4-1 success ", name[hash_alg]);fflush(stdout);
    }
    ...
    {
        printf("\r\n %s DMA test 4-2 success ", name[hash_alg]);fflush(stdout);
    }
    ...
    {
        printf("\r\n %s DMA test 4-final(hash dma node style) success ", name[hash_alg]);fflush(stdout);
    }
#endif
...
unsigned int HMAC_MD5_test(void)
{
    ...
    unsigned char std_mac6[16]  = {0x58,0x8C,0x28,0x9F,0x6C,0xB6,0x8F,0x70,0x2E,0x6B,0x1B,0x6F,0x6E,0x6D,0x61,0xEC,};
    unsigned int ret;
...
unsigned int HMAC_SHA1_test(void)
{
    ...
    unsigned char std_mac5[20]  = {0x62,0x83,0x15,0x6A,0xAD,0x36,0xD6,0x16,0xE2,0x59,0x45,0x36,0xBE,0x16,0xA1,0x91,
                             0xCD,0x15,0x35,0x99};
    unsigned char std_mac6[20]  = {0x3D,0x1D,0x95,0xED,0x73,0x8E,0xB6,0x2B,0x80,0x3B,0x66,0x32,0x33,0x03,0x37,0x3B,
                             0xF0,0xB6,0x20,0x33};
    unsigned int ret;
...
unsigned int HMAC_SHA224_test(void)
{
    ...
    unsigned char std_mac6[28]  = {0x0F,0x7F,0x6E,0x14,0x17,0xDD,0x4F,0xB3,0x6A,0x86,0xF8,0x4B,0xC2,0xF1,0xA0,0x4C,
...
unsigned int HMAC_SHA384_test(void)
{
    ...
    unsigned char std_mac6[48]  = {0xFA,0x84,0xF0,0x6F,0xDC,0x96,0x09,0x04,0x7E,0xC5,0xFC,0xCE,0x27,0xBC,0xCA,0xDE,
...
unsigned int HMAC_SHA512_test(void)
{
    ...
    unsigned char std_mac6[64]  = {0xAF,0xB6,0x5E,0x03,0x86,0x74,0x9A,0x5D,0xB0,0xA9,0x7E,0xC7,0xBE,0x89,0x44,0x90,
...
unsigned int HMAC_SHA512_224_test(void)
{
    ...
    unsigned char std_mac6[28]  = {0x83,0xFB,0x45,0xAC,0x4A,0x62,0x4C,0xB3,0x95,0x45,0x73,0xC9,0x49,0xE0,0x5F,0x74,
...
unsigned int HMAC_SHA512_256_test(void)
{
    ...
    unsigned char std_mac6[32]  = {0xEA,0xDD,0xF0,0x90,0x67,0x9C,0x90,0xC9,0x08,0x65,0x6A,0xF2,0x74,0x1E,0xBE,0xBF,
