...
{
    char *name_alg[] = {
        "SM3", "MD5", "SHA256", "SHA384", "SHA512", "SHA1", "SHA224", "SHA512_224", "SHA512_256", "SHA3_224", "SHA3_256", "SHA3_384", "SHA3_512",
    };
...
unsigned int hmac_md5_test(void)
{
    ...
    unsigned char std_mac2[16] = {
        0xA0, 0xD7, 0x2B, 0xDF, 0xA6, 0xE9, 0xCD, 0x3A, 0x56, 0xE6, 0x60, 0xEC, 0xA8, 0x92, 0xBF, 0xB0,
    };
    unsigned char std_mac3[16] = {
        0xBC, 0x69, 0xB2, 0x04, 0x59, 0x9A, 0x41, 0x04, 0x38, 0x2D, 0x55, 0x92, 0xE4, 0xDF, 0x9B, 0xC5,
    };
    unsigned char std_mac4[16] = {
        0x57, 0xE9, 0x03, 0x84, 0x77, 0xD2, 0xAC, 0x97, 0x8A, 0x2A, 0x07, 0x3C, 0xF7, 0x6A, 0x62, 0xFF,
    };
    unsigned char std_mac5[16] = {
        0x47, 0xAD, 0x92, 0xB8, 0x14, 0x0D, 0xBA, 0x75, 0x0E, 0x0F, 0xE8, 0x5B, 0xD5, 0x7A, 0x8E, 0xD6,
    };
    unsigned char std_mac6[16] = {
        0x58, 0x8C, 0x28, 0x9F, 0x6C, 0xB6, 0x8F, 0x70, 0x2E, 0x6B, 0x1B, 0x6F, 0x6E, 0x6D, 0x61, 0xEC,
    };
    unsigned int ret;
...
unsigned int hmac_sha384_test(void)
{
    unsigned char std_mac1[48] = {
        0x33, 0x7F, 0xDC, 0x69, 0xD3, 0x4B, 0x81, 0x52, 0x35, 0x5B, 0x11, 0xAF, 0xA9, 0x4C, 0xE9, 0x26, 0x3E, 0x97, 0xFC, 0xE0, 0x64, 0xB7, 0x60, 0xD0,
        0x48, 0x94, 0x86, 0x95, 0x0A, 0xF5, 0xE5, 0xC9, 0x36, 0x45, 0x88, 0xF2, 0x41, 0x16, 0x20, 0xD8, 0xAA, 0x55, 0x44, 0xDE, 0x2A, 0xD7, 0xEF, 0xE9,
    };
    unsigned char std_mac2[48] = {
        0x62, 0x7B, 0x51, 0x3F, 0x45, 0xBA, 0x31, 0xB9, 0xD7, 0xE0, 0x18, 0x29, 0x8D, 0xEE, 0xF5, 0x23, 0xBA, 0x93, 0xE0, 0x26, 0x8C, 0x77, 0xC6, 0x33,
        0xB5, 0xCC, 0xC0, 0x49, 0xCE, 0x41, 0xEC, 0x94, 0x0C, 0x33, 0xE5, 0x08, 0xF0, 0x74, 0x2D, 0xB2, 0x3B, 0x94, 0xD0, 0x7E, 0xC7, 0xCE, 0x86, 0xF0,
    };
    unsigned char std_mac3[48] = {
        0x73, 0x30, 0x35, 0xA1, 0x60, 0xEF, 0xA5, 0x7F, 0xBB, 0x76, 0x88, 0x94, 0x00, 0x76, 0xCD, 0x86, 0x1E, 0x61, 0x56, 0x22, 0x8E, 0xFA, 0xBA, 0xFC,
        0x24, 0xA2, 0x56, 0xD2, 0x0A, 0x40, 0x49, 0x63, 0x24, 0xC4, 0x83, 0x15, 0xAC, 0x5B, 0x97, 0xC1, 0xA1, 0x77, 0x11, 0x8E, 0x6A, 0x63, 0x41, 0x51,
    };
    unsigned char std_mac4[48] = {
        0x88, 0x34, 0xD0, 0x20, 0x3D, 0x61, 0x95, 0xFD, 0x05, 0x67, 0x25, 0xE6, 0x1C, 0xA1, 0x42, 0xF1, 0x9B, 0x27, 0x88, 0x89, 0xDB, 0x93, 0x16, 0x60,
        0x5B, 0xA1, 0xD8, 0x10, 0xF7, 0x45, 0xBE, 0xDD, 0x8F, 0xAE, 0x04, 0x86, 0xE5, 0xE2, 0xF5, 0xF6, 0x78, 0x4A, 0xC8, 0x60, 0x7A, 0xC8, 0x5A, 0x65,
    };
    unsigned char std_mac5[48] = {
        0xF3, 0xAC, 0x1F, 0x24, 0xDF, 0x89, 0xE7, 0x1C, 0xE6, 0x9F, 0x09, 0xDC, 0x0B, 0xA7, 0x1C, 0xF0, 0x34, 0xD5, 0x21, 0x54, 0xE7, 0x34, 0x22, 0x89,
        0xE3, 0x07, 0xEE, 0x13, 0x44, 0xE0, 0x73, 0xE1, 0x30, 0xEF, 0xD0, 0xBE, 0xC8, 0x72, 0xCC, 0xD6, 0xFB, 0x66, 0xDE, 0xB3, 0x06, 0x9F, 0x6A, 0xA7,
    };
    unsigned char std_mac6[48] = {
        0xFA, 0x84, 0xF0, 0x6F, 0xDC, 0x96, 0x09, 0x04, 0x7E, 0xC5, 0xFC, 0xCE, 0x27, 0xBC, 0xCA, 0xDE, 0x11, 0x68, 0x60, 0xFC, 0x0E, 0xEE, 0x4B, 0xC5,
        0xA3, 0x01, 0xFF, 0xB7, 0x7C, 0xA3, 0x72, 0x97, 0xDD, 0x19, 0xC5, 0x68, 0x64, 0x4F, 0xD6, 0xBC, 0x85, 0x98, 0xB2, 0x8F, 0xF9, 0xBD, 0xC0, 0x4C,
    };
    unsigned int ret;
...
unsigned int hmac_sha512_224_test(void)
{
    unsigned char std_mac1[28] = {
        0x38, 0x80, 0x12, 0x74, 0x68, 0x49, 0x93, 0xE0, 0x9E, 0xA9, 0xEF, 0x53, 0x55, 0xC4, 0xF8, 0xAD, 0xC9, 0x00, 0x87, 0xAF, 0xDF, 0xCF, 0x3D, 0xEC, 0xF5, 0x25, 0xC9, 0xF6,
    };
    unsigned char std_mac2[28] = {
        0x14, 0x2D, 0x9A, 0x66, 0x64, 0x1A, 0x89, 0x63, 0x3D, 0x84, 0x19, 0xB1, 0x9E, 0x84, 0x6D, 0x33, 0xE9, 0x67, 0x14, 0x69, 0xE7, 0x2F, 0xB7, 0x96, 0x5C, 0x24, 0xAD, 0x47,
    };
    unsigned char std_mac3[28] = {
        0x09, 0x07, 0x55, 0x93, 0xD2, 0x7D, 0x42, 0x48, 0xB9, 0x2B, 0x66, 0x08, 0x5C, 0x6E, 0x47, 0xEC, 0x50, 0xDA, 0x3F, 0xE9, 0x5C, 0x6A, 0x21, 0x9D, 0xCA, 0x8C, 0x00, 0xE1,
    };
    unsigned char std_mac4[28] = {
        0xC3, 0x25, 0x31, 0xC8, 0xF7, 0x7D, 0xD8, 0xB6, 0x59, 0x98, 0xF9, 0x72, 0x8D, 0x3D, 0x34, 0xD3, 0xFF, 0xBB, 0x45, 0x15, 0xE3, 0x0A, 0x3B, 0xCD, 0x17, 0xA7, 0xA4, 0x9D,
    };
    unsigned char std_mac5[28] = {
        0x51, 0x47, 0x22, 0x94, 0x7A, 0x70, 0x8E, 0xCB, 0xF8, 0xDA, 0x62, 0xEC, 0x07, 0xD9, 0xD9, 0x43, 0x21, 0x4B, 0x5A, 0x65, 0xD7, 0xC7, 0xBD, 0x58, 0x5A, 0x8F, 0xCF, 0x65,
    };
    unsigned char std_mac6[28] = {
        0x83, 0xFB, 0x45, 0xAC, 0x4A, 0x62, 0x4C, 0xB3, 0x95, 0x45, 0x73, 0xC9, 0x49, 0xE0, 0x5F, 0x74, 0x89, 0x13, 0x69, 0xE7, 0x09, 0x5F, 0x13, 0xEF, 0x77, 0xC1, 0x76, 0x93,
    };
    unsigned int ret;
