...
unsigned int sample_test_hmac_sha1(void)
{
    ...
    unsigned char std_mac[20] = {0x06, 0x10, 0x3A, 0xED, 0x2A, 0x69, 0x71, 0xF6, 0x8F, 0x1A, 0x83, 0xAC, 0x5F, 0x0D, 0x01, 0xA0, 0xCF, 0xFE, 0x16, 0xCD};
    ...
    hmac_sha1_ctx_t hmac_sha1_ctx[1];
    hmac_ctx_t     *hmac_ctx = hmac_sha1_ctx;
    ...
    hmac_sha1_dma_ctx_t hmac_sha1_dma_ctx[1];
    hmac_dma_ctx_t     *hmac_dma_ctx = hmac_sha1_dma_ctx;
