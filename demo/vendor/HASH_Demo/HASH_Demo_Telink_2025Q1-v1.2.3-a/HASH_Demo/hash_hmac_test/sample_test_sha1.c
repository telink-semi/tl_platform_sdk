...
unsigned int sample_test_sha1(void)
{
    ...
    unsigned char std_digest[20] = {0x8F, 0x6F, 0x86, 0x53, 0x31, 0x4A, 0x3B, 0x0F, 0xBD, 0x88, 0x03, 0xFD, 0xC2, 0xC9, 0x7E, 0x26, 0x5E, 0x7A, 0xCE, 0x48};
    ...
    sha1_ctx_t  sha1_ctx[1];
    hash_ctx_t *hash_ctx = sha1_ctx;
    ...
    sha1_dma_ctx_t  sha1_dma_ctx[1];
    hash_dma_ctx_t *hash_dma_ctx = sha1_dma_ctx;
