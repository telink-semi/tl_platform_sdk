...
unsigned int sample_test_sm3(void)
{
    ...
    unsigned char std_digest[32] = {0xE1, 0x6D, 0xDB, 0xC7, 0x44, 0x3A, 0x9C, 0xE1, 0xBE, 0x1E, 0x5A, 0x39, 0x6B, 0x34, 0x52, 0x6C,
    ...
    sm3_dma_ctx_t   sm3_dma_ctx[1];
    hash_dma_ctx_t *hash_dma_ctx = sm3_dma_ctx;
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SM3 sample test 5 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SM3 sample test 5 success"); //fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SM3 dma sample test 5 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SM3 dma sample test 5 success"); //fflush(stdout);
    }
