...
unsigned int sample_test_sha256(void)
{
    ...
    unsigned char std_digest[32] = {0x9A, 0xFB, 0x65, 0x73, 0x35, 0xA9, 0x7C, 0x53, 0x6A, 0x5F, 0xD6, 0xCC, 0x15, 0xBD, 0xCC, 0xC4,
    ...
    sha256_ctx_t sha256_ctx[1];
    hash_ctx_t  *hash_ctx = sha256_ctx;
    ...
    sha256_dma_ctx_t sha256_dma_ctx[1];
    hash_dma_ctx_t  *hash_dma_ctx = sha256_dma_ctx;
