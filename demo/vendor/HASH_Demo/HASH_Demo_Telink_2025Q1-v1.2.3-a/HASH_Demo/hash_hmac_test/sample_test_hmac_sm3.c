...
unsigned int sample_test_hmac_sm3(void)
{
    ...
    unsigned char std_mac[32] = {0x3D, 0x84, 0x7C, 0x6E, 0x58, 0xA3, 0xC8, 0xB7, 0xA4, 0x4E, 0xBE, 0xF6, 0x43, 0xBF, 0x85, 0x73,
    ...
    hmac_sm3_ctx_t hmac_sm3_ctx[1];
    hmac_ctx_t    *hmac_ctx = hmac_sm3_ctx;
    ...
    hmac_sm3_dma_ctx_t hmac_sm3_dma_ctx[1];
    hmac_dma_ctx_t    *hmac_dma_ctx = hmac_sm3_dma_ctx;
