...
unsigned int sample_test_hmac_md5(void)
{
    ...
    hmac_md5_ctx_t hmac_md5_ctx[1];
    hmac_ctx_t    *hmac_ctx = hmac_md5_ctx;
    ...
    hmac_md5_dma_ctx_t hmac_md5_dma_ctx[1];
    hmac_dma_ctx_t    *hmac_dma_ctx = hmac_md5_dma_ctx;
    ...
    if (memcmp_(std_mac, mac, mac_byte_len)) {
        printf("\r\n HMAC-MD5 sample test 1 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 sample test 1 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, mac, mac_byte_len)) {
        printf("\r\n HMAC-MD5 sample test 2 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 sample test 2 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, mac, mac_byte_len)) {
        printf("\r\n HMAC-MD5 sample test 3 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 sample test 3 success");
        fflush(stdout);
    }
#endif
    ...
    if (memcmp_(std_mac, mac, mac_byte_len)) {
        printf("\r\n HMAC-MD5 sample test 4 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 sample test 4 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, mac, mac_byte_len)) {
        printf("\r\n HMAC-MD5 sample test 5 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 sample test 5 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, mac, mac_byte_len)) {
        printf("\r\n HMAC-MD5 sample test 6 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 sample test 6 success");
        fflush(stdout);
    }
#endif
    ...
    if (memcmp_(std_mac, (unsigned char *)mac_buf, mac_byte_len)) {
        printf("\r\n HMAC-MD5 dma sample test 1 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 dma sample test 1 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, (unsigned char *)mac_buf, mac_byte_len)) {
        printf("\r\n HMAC-MD5 dma sample test 2 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 dma sample test 2 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, (unsigned char *)mac_buf, mac_byte_len)) {
        printf("\r\n HMAC-MD5 dma sample test 3 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 dma sample test 3 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, (unsigned char *)mac_buf, mac_byte_len)) {
        printf("\r\n HMAC-MD5 dma sample test 4 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 dma sample test 4 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, (unsigned char *)mac_buf, mac_byte_len)) {
        printf("\r\n HMAC-MD5 dma sample test 5 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 dma sample test 5 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_mac, (unsigned char *)mac_buf, mac_byte_len)) {
        printf("\r\n HMAC-MD5 dma sample test 6 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n HMAC-MD5 dma sample test 6 success");
        fflush(stdout);
    }
