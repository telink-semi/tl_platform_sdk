...
unsigned int sample_test_md5(void)
{
    ...
    md5_dma_ctx_t   md5_dma_ctx[1];
    hash_dma_ctx_t *hash_dma_ctx = md5_dma_ctx;
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n MD5 sample test 1 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 sample test 1 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n MD5 sample test 2 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 sample test 2 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n MD5 sample test 3 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 sample test 3 success");
        fflush(stdout);
    }
#endif
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n MD5 sample test 4 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 sample test 4 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n MD5 sample test 5 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 sample test 5 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n MD5 sample test 6 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 sample test 6 success");
        fflush(stdout);
    }
#endif
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n MD5 dma sample test 1 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 dma sample test 1 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n MD5 dma sample test 2 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 dma sample test 2 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n MD5 dma sample test 3 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 dma sample test 3 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n MD5 dma sample test 4 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 dma sample test 4 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n MD5 dma sample test 5 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 dma sample test 5 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n MD5 dma sample test 6 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n MD5 dma sample test 6 success");
        fflush(stdout);
    }
