...
unsigned int sample_test_sha224(void)
{
    ...
    unsigned char std_digest[28] = {0xB4, 0xAD, 0x8D, 0xA3, 0x53, 0x93, 0x88, 0xB6, 0xBF, 0xBE, 0x9C, 0xDA, 0x65, 0x78,
                                    0x5F, 0x87, 0xFE, 0xD9, 0x2D, 0x29, 0x32, 0x4F, 0x3C, 0x6B, 0xC4, 0xEF, 0xF1, 0x5D};
    ...
    sha224_ctx_t sha224_ctx[1];
    hash_ctx_t  *hash_ctx = sha224_ctx;
    ...
    sha224_dma_ctx_t sha224_dma_ctx[1];
    hash_dma_ctx_t  *hash_dma_ctx = sha224_dma_ctx;
