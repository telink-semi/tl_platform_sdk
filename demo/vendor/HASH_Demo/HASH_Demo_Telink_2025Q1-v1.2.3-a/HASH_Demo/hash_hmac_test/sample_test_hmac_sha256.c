...
unsigned int sample_test_hmac_sha256(void)
{
    ...
    unsigned char std_mac[32] = {0x8E, 0x11, 0x01, 0x63, 0x24, 0xBF, 0xE8, 0xA6, 0xF3, 0x71, 0x4A, 0xF1, 0x38, 0xE6, 0x26, 0xA9,
    ...
    hmac_sha256_ctx_t hmac_sha256_ctx[1];
    hmac_ctx_t       *hmac_ctx = hmac_sha256_ctx;
    ...
    hmac_sha256_dma_ctx_t hmac_sha256_dma_ctx[1];
    hmac_dma_ctx_t       *hmac_dma_ctx = hmac_sha256_dma_ctx;
