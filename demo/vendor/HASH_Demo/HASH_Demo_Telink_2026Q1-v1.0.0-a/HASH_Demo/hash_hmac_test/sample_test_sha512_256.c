...
unsigned int sample_test_sha512_256(void)
{
    ...
    unsigned char std_digest[32] = {0xF8, 0xC2, 0x81, 0x72, 0xFB, 0x4A, 0x62, 0xD0, 0xA1, 0x87, 0xEB, 0x11, 0xB4, 0xA3, 0x84, 0x38,
                                    0xE8, 0xAF, 0x31, 0x24, 0xB9, 0xFE, 0xBA, 0xAA, 0x5D, 0x63, 0x6D, 0xEE, 0xB8, 0x01, 0x9B, 0x34};
    ...
    sha512_256_ctx_t sha512_256_ctx[1];
    hash_ctx_t      *hash_ctx = sha512_256_ctx;
    ...
    sha512_256_ctx_dma_t sha512_256_dma_ctx[1];
    hash_dma_ctx_t      *hash_dma_ctx = sha512_256_dma_ctx;
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA512_256 sample test 1 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 sample test 1 success"); //fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA512_256 sample test 2 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 sample test 2 success"); //fflush(stdout);
    }
    ...
    node[2].msg_len  = 32;
    ret              = sha512_256_node_steps(node, 3, digest);
    if (HASH_SUCCESS != ret) {
        return 1;
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA512_256 sample test 4 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 sample test 4 success"); //fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA512_256 sample test 5 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 sample test 5 success"); //fflush(stdout);
    }
    ...
    node[2].msg_addr = msg + 48;
    node[2].msg_len  = 32;
    ret              = hash_node_steps(HASH_SHA512_256, node, 3, digest);
    if (HASH_SUCCESS != ret) {
        return 1;
    }

    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA512_256 sample test 6 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 sample test 6 success");
        fflush(stdout);
    }
#endif
    ...
    ret = sha512_256_dma_update_blocks(sha512_256_dma_ctx, msg_buf, blocks_bytes);
    if (HASH_SUCCESS != ret) {
        return 1;
    }

    ret = sha512_256_dma_final(sha512_256_dma_ctx, msg_buf + blocks_bytes / 4, remainder_bytes, digest_buf);
    if (HASH_SUCCESS != ret) {
        return 1;
    }

    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA512_256 dma sample test 1 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 dma sample test 1 success"); //fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA512_256 dma sample test 2 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 dma sample test 2 success"); //fflush(stdout);
    }
    ...
    ret                  = sha512_256_dma_node_steps(dma_node, 2, digest_buf, hash_call_manage);
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA512_256 dma sample test 4 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 dma sample test 4 success"); //fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA512_256 dma sample test 5 error"); //fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 dma sample test 5 success"); //fflush(stdout);
    }
    ...
    dma_node[1].msg_addr = dma_node[0].msg_addr + dma_node[0].msg_len / 4;
    dma_node[1].msg_len  = remainder_bytes;
    ret                  = hash_dma_node_steps(HASH_SHA512_256, dma_node, 2, digest_buf, hash_call_manage);
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA512_256 dma sample test 6 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_256 dma sample test 6 success");
        fflush(stdout);
    }
