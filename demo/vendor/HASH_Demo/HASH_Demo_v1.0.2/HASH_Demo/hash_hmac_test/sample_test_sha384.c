...
unsigned int sample_test_sha384(void)
{
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA384 sample test 1 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA384 sample test 1 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA384 sample test 2 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA384 sample test 2 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA384 sample test 4 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA384 sample test 4 success");
        fflush(stdout);
    }
    ...
    ret = sha384_dma_update_blocks(sha384_dma_ctx, msg_buf, msg_words);
    if (HASH_SUCCESS != ret) {
        return 1;
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA384 dma sample test 1 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA384 dma sample test 1 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA384 dma sample test 2 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA384 dma sample test 2 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA384 dma sample test 4 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA384 dma sample test 4 success");
        fflush(stdout);
    }
