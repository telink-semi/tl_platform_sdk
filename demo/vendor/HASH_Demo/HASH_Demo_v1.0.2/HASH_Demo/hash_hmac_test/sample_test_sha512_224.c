...
unsigned int sample_test_sha512_224(void)
{
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA512_224 sample test 1 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_224 sample test 1 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA512_224 sample test 2 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_224 sample test 2 success");
        fflush(stdout);
    }
    ...
    if (memcmp_(std_digest, digest, digest_byte_len)) {
        printf("\r\n SHA512_224 sample test 4 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_224 sample test 4 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA512_224 dma sample test 1 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_224 dma sample test 1 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA512_224 dma sample test 2 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_224 dma sample test 2 success");
        fflush(stdout);
    }
    ...
    if (uint32_BigNumCmp((unsigned int *)std_digest, digest_byte_len / 4, digest_buf, digest_byte_len / 4)) {
        printf("\r\n SHA512_224 dma sample test 4 error");
        fflush(stdout);
        return 1;
    } else {
        printf("\r\n SHA512_224 dma sample test 4 success");
        fflush(stdout);
    }
