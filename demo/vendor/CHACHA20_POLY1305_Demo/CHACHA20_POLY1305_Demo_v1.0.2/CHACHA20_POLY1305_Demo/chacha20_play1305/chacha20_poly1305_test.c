...
unsigned int chacha20_poly1305_test_internal(unsigned char wordAlign, unsigned char *std_plain, unsigned int byteLen, unsigned char *key, unsigned char *iv, unsigned int constant, unsigned char *aad, unsigned char aadByteLen, unsigned char *std_cipher, unsigned char *std_tag)
{
...
#ifdef CHACHA20_POLY1305_DMA_FUNCTION
unsigned int chacha20_poly1305_dma_test_internal(unsigned char *std_plain, unsigned int byteLen, unsigned char *key, unsigned char *iv, unsigned int constant, unsigned char *aad, unsigned char aadByteLen, unsigned char *std_cipher, unsigned char *std_tag)
{
    unsigned int i, j;
    unsigned int ret;
    unsigned int round     = byteLen / 64;
...
unsigned int chacha20_poly1305_standard_data_test(void)
{
    ...
    for (i = 0; i < 9; i++) {
        ret = chacha20_poly1305_test_internal(1, (unsigned char *)vector[i].std_plain, vector[i].c_bytes, (unsigned char *)vector[i].key, (unsigned char *)vector[i].iv, vector[i].constant, (unsigned char *)vector[i].aad, vector[i].aad_bytes, (unsigned char *)vector[i].std_cipher, (unsigned char *)vector[i].std_tag);
        if (ret) {
            return 1;
        }

        ret = chacha20_poly1305_test_internal(0, (unsigned char *)vector[i].std_plain, vector[i].c_bytes, (unsigned char *)vector[i].key, (unsigned char *)vector[i].iv, vector[i].constant, (unsigned char *)vector[i].aad, vector[i].aad_bytes, (unsigned char *)vector[i].std_cipher, (unsigned char *)vector[i].std_tag);
        if (ret) {
            return 1;
        }

#ifdef CHACHA20_POLY1305_DMA_FUNCTION
        ret = chacha20_poly1305_dma_test_internal((unsigned char *)vector[i].std_plain, vector[i].c_bytes, (unsigned char *)vector[i].key, (unsigned char *)vector[i].iv, vector[i].constant, (unsigned char *)vector[i].aad, vector[i].aad_bytes, (unsigned char *)vector[i].std_cipher, (unsigned char *)vector[i].std_tag);
        if (ret) {
            return 1;
        }
#endif
...
unsigned int chacha20_poly1305_sample_test(void)
{
    ...
    if (CHACHA20_POLY1305_SUCCESS != ret || memcmp_(tmp_tag2, std_tag2, 16) || memcmp_(tmp_out, std_plain1, 265) || memcmp_(tmp_out2, std_cipher2, 114)) {
    ...
    if (CHACHA20_POLY1305_SUCCESS != ret || memcmp_(tmp_tag2, std_tag2, 16) || memcmp_((unsigned char *)out_buf, std_plain1, 265) || memcmp_((unsigned char *)out2_buf, std_cipher2, 114)) {
