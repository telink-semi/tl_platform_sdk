...
#else
        Microseconds          = (float)User_Time * Mic_secs_Per_Second / ((float)SYSTEM_TIMER_TICK_1S * ((float)Number_Of_Runs));
        Dhrystones_Per_Second = ((float)SYSTEM_TIMER_TICK_1S * (float)Number_Of_Runs) / (float)User_Time;
#endif
