...
void user_init(void)
{
    ...
    || (defined(MCU_CORE_B92) && ((PM_MODE == SUSPEND_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET32K_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET64K_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET96K_COMPARATOR_WAKEUP))) 
    || (defined(MCU_CORE_TL721X) && ((PM_MODE == SUSPEND_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET32K_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET64K_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET128K_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET256K_COMPARATOR_WAKEUP))) 
    || (defined(MCU_CORE_TL321X) && ((PM_MODE == SUSPEND_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET32K_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET64K_COMPARATOR_WAKEUP) || (PM_MODE == DEEP_RET96K_COMPARATOR_WAKEUP)))
    gpio_function_en(LED3);
    gpio_output_en(LED3);
    gpio_input_dis(LED3);
    gpio_function_en(LED4);
    ...
    if (PM_MODE == SUSPEND_32K_RC_WAKEUP || PM_MODE == DEEP_32K_RC_WAKEUP || PM_MODE == DEEP_RET32K_32K_RC_WAKEUP || PM_MODE == DEEP_RET64K_32K_RC_WAKEUP || PM_MODE == DEEP_RET128K_32K_RC_WAKEUP || PM_MODE == DEEP_RET256K_32K_RC_WAKEUP\
        || PM_MODE == SUSPEND_COMPARATOR_WAKEUP || PM_MODE == DEEP_COMPARATOR_WAKEUP || PM_MODE == DEEP_RET32K_COMPARATOR_WAKEUP || PM_MODE == DEEP_RET64K_COMPARATOR_WAKEUP || PM_MODE == DEEP_RET128K_COMPARATOR_WAKEUP || PM_MODE == DEEP_RET256K_COMPARATOR_WAKEUP) {
        clock_32k_init(CLK_32K_RC);
        clock_cal_32k_rc(); //6.68ms
    } else if (PM_MODE == SUSPEND_32K_XTAL_WAKEUP || PM_MODE == DEEP_32K_XTAL_WAKEUP || PM_MODE == DEEP_RET32K_32K_XTAL_WAKEUP || PM_MODE == DEEP_RET64K_32K_XTAL_WAKEUP || PM_MODE == DEEP_RET128K_32K_XTAL_WAKEUP || PM_MODE == DEEP_RET256K_32K_XTAL_WAKEUP) {
        clock_32k_init(CLK_32K_XTAL);
        clock_kick_32k_xtal(10);
    }
    ...
    #elif ((defined(MCU_CORE_B92) || defined(MCU_CORE_TL321X)) && (PM_MODE == DEEP_RET96K_32K_RC_WAKEUP || PM_MODE == DEEP_RET96K_32K_XTAL_WAKEUP))
    retention_data_test++;
    pm_sleep_wakeup(DEEPSLEEP_MODE_RET_SRAM_LOW96K, PM_WAKEUP_TIMER, PM_TICK_STIMER, (stimer_get_tick() + 4000 * SYSTEM_TIMER_TICK_1MS));

    #elif (defined(MCU_CORE_TL721X) && (PM_MODE == DEEP_RET128K_32K_RC_WAKEUP || PM_MODE == DEEP_RET128K_32K_XTAL_WAKEUP))
    retention_data_test++;
    ...
    #elif (defined(MCU_CORE_TL721X) && (PM_MODE == DEEP_RET256K_32K_RC_WAKEUP || PM_MODE == DEEP_RET256K_32K_XTAL_WAKEUP))
    retention_data_test++;
