...
void user_init(void)
{
    ...
    #if defined(MCU_CORE_TL7518) || defined(MCU_CORE_TL751X) || defined(MCU_CORE_TL753X) || defined(MCU_CORE_TL711X) || defined(MCU_CORE_TL322X)|| defined(MCU_CORE_TL522X)
    ...
    #if defined(MCU_CORE_TL721X) || defined(MCU_CORE_TL321X) || defined(MCU_CORE_TL323X) || defined(MCU_CORE_TL521X) || defined(MCU_CORE_TL322X)|| defined(MCU_CORE_TL522X)
...
_attribute_ram_code_sec_ void stimer_irq_handler(void)
{
    ...
    #endif
    {
        ...
        stimer_set_irq_capture_d25f(stimer_get_tick() + SYSTEM_TIMER_TICK_1MS);
    #elif defined(MCU_CORE_TL322X)|| defined(MCU_CORE_TL522X)
        stimer_clr_irq_status_d25f(FLD_SYSTEM_IRQ_D25F); /* clr irq */
        stimer_set_irq_capture_d25f(stimer_get_tick() + SYSTEM_TIMER_TICK_1MS);
    #else
        stimer_clr_irq_status(FLD_SYSTEM_IRQ); /* clr irq */
