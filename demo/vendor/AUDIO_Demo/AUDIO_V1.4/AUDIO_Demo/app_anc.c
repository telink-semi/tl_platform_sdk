...
#define ANC_HB_REF012ERR01_MODE                  (1)// ram pass
#define ANC_HB_REF012ERR0_MODE                   (2)// ram pass
#define ANC_HB_REF01ERR01_MODE                   (3)// ram pass
#define ANC_HB_REF01ERR0_MODE                    (4)// ram pass
#define ANC_HB_REF0ERR0_MODE                     (5)// ram pass
#define ANC_HB_REF0ERR01_MODE                    (6)// ram pass
#define ANC_FF_REF0_MODE                         (7)// ram pass
#define ANC_FF_REF0WZ384_MODE                    (8)// ram pass
#define ANC_HB_REF0WZ384ERR0CZ256_MODE           (9)// ram pass
//#define ANC_FB_MODE                              (10)
#define ANC_HB_REF012ERR01_MODE_PLUS_GAIN        (11)// ram pass
#define ANC_HB_REF0WZ384ERR0CZ256_MODE_PLUS_GAIN (12)// ram pass
#define ANC_HB_REF012ERR01_MODE_PLUS_RESAMPLE    (13)// ram pass
#define ANC_BZ_TEST                              (14)
#define ANC_HB_REF0ERR0_MODE_PLUS_RESAMPLE       (16)// ram pass
#define ANC_HB_REF012ERR01_MODE_PLUS_REFDC       (17)// ram pass
#define ANC_FF_REF0_MODE_I2S                     (18)
#define ANC_FB_MODE                              (19) //ram pass
#define ANC_HB_REF0WZ384ERR0CZ256_MODE_PLUS_RESAMPLE (20) //ram pass
#define ANC_FB_MODE_PLUS_RESAMPLE                (21) //ram pass
#define ANC_FF_REF0WZ384_MODE_PLUS_RESAMPLE      (22)
#define ANC_HB_REF012ERR0_MODE_PLUS_RESAMPLE     (23)
#define ANC_COFF_UPDATE                          (24)

#define ANC_MODE                                ANC_FB_MODE

#define ANC_CHANNEL_SELECT                      ANC0

#define ANC_FS                                  192000 / 2
...
#define Limiter_Test                0 // 0:wz_sum right shift 0, cz_sum right shift 0; 1:wz_sum right shift 1, cz_sum right shift 2; 2:wz_sum right shift 2, cz_sum right shift 3;2:wz_sum right shift 3, cz_sum right shift 1;
    ...
    int resample_hb3_coff[7] = {-3579,31041,-142644,469196,-1333012,5173296,8388608};//default
    short resample_droop_coff[5] = {1,-4,12,-58,2100};
    unsigned short in_data_rate_384 = 0;
    unsigned short in_data_rate_48 = 0;
    audio_init(PLL_AUDIO_CLK_86P016M); /* must configured first. */
    audio_matrix_set_rx_fifo_route(FIFO0, FIFO_RX_ROUTE_EQ0, FIFO_RX_HAC_EQ_MONO_20_OR_24BIT);
    audio_rx_dma_chain_init(FIFO0, DMA0, (unsigned short *)AUDIO_BUFFER_OUT2, sizeof(AUDIO_BUFFER_OUT2));
    ...
    // hac config
    in_data_rate_384 = (43008000 / 384000 )-1;
    in_data_rate_48  = (43008000 / 48000 )-1;
    audio_hac_set_in_data_rate(HAC_CH0_EQ0, in_data_rate_384);
    audio_hac_set_in_data_rate(HAC_CH1_EQ1, in_data_rate_48);
...
#define Resample_Mode     0 //0:48k->192k; 1:48k->384k; 2:96k->192k; 3:96k->384k
    int resample_hb1_coff[21] = {-463,1168,-2563,4960,-8808,14673,-23252,35383,-52075,74549,-104325,143386,-194500,261864,-352495,479510,-671043,1000613,-1738887,5326482,8388608};//default
    int resample_hb2_coff[7] = {-3579,31041,-142644,469196,-1333012,5173296,8388608};//default
    int resample_hb3_coff[7] = {-3579,31041,-142644,469196,-1333012,5173296,8388608};//default
    short resample_droop_coff[5] = {1,-4,12,-58,2100};
...
#define ANC_MODE_HB_REF012ERR01_COFF_UPDATE               1// flash pass, ram pass
#define ANC_MODE_HB_REF012ERR0_COFF_UPDATE                2// flash pass, ram pass
#define ANC_MODE_HB_REF01ERR01_COFF_UPDATE                3// flash pass, ram pass
#define ANC_MODE_HB_REF01ERR0_COFF_UPDATE                 4// flash pass, ram pass
#define ANC_MODE_HB_REF0ERR0_COFF_UPDATE                  5// flash pass, ram pass
#define ANC_MODE_HB_REF0ERR01_COFF_UPDATE                 6// flash pass, ram pass
#define ANC_MODE_FF_REF0_COFF_UPDATE                      7// flash pass, ram pass
#define ANC_MODE_FF_REF0WZ384_COFF_UPDATE                 8// flash pass, ram pass
#define ANC_MODE_HB_REF0WZ384ERR0CZ256_COFF_UPDATE        9// flash pass, ram pass
...
#define ANC_COFF_UPDATE_MODE                              ANC_MODE_FB_RESAMPLE_UPDATE
    ...
    //audio_anc_update_wcz_iir_coef(ANC_CHANNEL_SELECT, ANC0_WCZ1, cz_iir);  //cz0
    {
        ...
        {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b0(ANC_CHANNEL_SELECT, ANC0_WCZ0, i) = wz_iir_bypass[i][0];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b1(ANC_CHANNEL_SELECT, ANC0_WCZ0, i) = wz_iir_bypass[i][1];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b2(ANC_CHANNEL_SELECT, ANC0_WCZ0, i) = wz_iir_bypass[i][2];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_a1(ANC_CHANNEL_SELECT, ANC0_WCZ0, i) = wz_iir_bypass[i][3];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_a2(ANC_CHANNEL_SELECT, ANC0_WCZ0, i) = wz_iir_bypass[i][4];
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b0(ANC_CHANNEL_SELECT, ANC0_WCZ2, i) = wz_iir_bypass[i][0];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b1(ANC_CHANNEL_SELECT, ANC0_WCZ2, i) = wz_iir_bypass[i][1];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b2(ANC_CHANNEL_SELECT, ANC0_WCZ2, i) = wz_iir_bypass[i][2];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_a1(ANC_CHANNEL_SELECT, ANC0_WCZ2, i) = wz_iir_bypass[i][3];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_a2(ANC_CHANNEL_SELECT, ANC0_WCZ2, i) = wz_iir_bypass[i][4];
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b0(ANC_CHANNEL_SELECT, ANC0_WCZ1, i) = wz_iir_bypass[i][0];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b1(ANC_CHANNEL_SELECT, ANC0_WCZ1, i) = wz_iir_bypass[i][1];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b2(ANC_CHANNEL_SELECT, ANC0_WCZ1, i) = wz_iir_bypass[i][2];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_a1(ANC_CHANNEL_SELECT, ANC0_WCZ1, i) = wz_iir_bypass[i][3];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_a2(ANC_CHANNEL_SELECT, ANC0_WCZ1, i) = wz_iir_bypass[i][4];
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b0(ANC_CHANNEL_SELECT, ANC0_WCZ3, i) = wz_iir_bypass[i][0];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b1(ANC_CHANNEL_SELECT, ANC0_WCZ3, i) = wz_iir_bypass[i][1];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_b2(ANC_CHANNEL_SELECT, ANC0_WCZ3, i) = wz_iir_bypass[i][2];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_a1(ANC_CHANNEL_SELECT, ANC0_WCZ3, i) = wz_iir_bypass[i][3];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_wcz_iir_a2(ANC_CHANNEL_SELECT, ANC0_WCZ3, i) = wz_iir_bypass[i][4];
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_cz3_iir_b0(ANC_CHANNEL_SELECT, i) = wz_iir_bypass[i][0];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_cz3_iir_b1(ANC_CHANNEL_SELECT, i) = wz_iir_bypass[i][1];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_cz3_iir_b2(ANC_CHANNEL_SELECT, i) = wz_iir_bypass[i][2];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_cz3_iir_a1(ANC_CHANNEL_SELECT, i) = wz_iir_bypass[i][3];
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
            reg_audio_anc_cz3_iir_a2(ANC_CHANNEL_SELECT, i) = wz_iir_bypass[i][4];
        }
    }
    //audio_anc_update_wcz_fir_coef(ANC_CHANNEL_SELECT, ANC0_WCZ0, wz0_fir); //wz0
    //audio_anc_update_wcz_fir_coef(ANC_CHANNEL_SELECT, ANC0_WCZ1, cz0_fir); //cz0
    {
        ...
        for (unsigned char i = 0; i < 16; i++)
        {
            ...
            {
                while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
                REG_ADDR32(REG_AUDIO_ANC_COEF(ANC_CHANNEL_SELECT) + 0xa80 + (ANC0_WCZ0) * 0x200 + i * 0x20 + j * 4) = ((wz_fir_bypass[i + j * 32 + 16] << 16) & 0xFFFF0000) | (wz_fir_bypass[i + j * 32] & 0xFFFF);
            }
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        for (unsigned char i = 0; i < 16; i++)
        {
            ...
            {
                while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
                REG_ADDR32(REG_AUDIO_ANC_COEF(ANC_CHANNEL_SELECT) + 0xa80 + (ANC0_WCZ2) * 0x200 + i * 0x20 + j * 4) = ((wz_fir_bypass[i + j * 32 + 16] << 16) & 0xFFFF0000) | (wz_fir_bypass[i + j * 32] & 0xFFFF);
            }
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        for (unsigned char i = 0; i < 16; i++)
        {
            ...
            {
                while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
                REG_ADDR32(REG_AUDIO_ANC_COEF(ANC_CHANNEL_SELECT) + 0xa80 + (ANC0_WCZ1) * 0x200 + i * 0x20 + j * 4) = ((wz_fir_bypass[i + j * 32 + 16] << 16) & 0xFFFF0000) | (wz_fir_bypass[i + j * 32] & 0xFFFF);
            }
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        for (unsigned char i = 0; i < 16; i++)
        {
            ...
            {
                while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
                REG_ADDR32(REG_AUDIO_ANC_COEF(ANC_CHANNEL_SELECT) + 0xa80 + (ANC0_WCZ3) * 0x200 + i * 0x20 + j * 4) = ((wz_fir_bypass[i + j * 32 + 16] << 16) & 0xFFFF0000) | (wz_fir_bypass[i + j * 32] & 0xFFFF);
            }
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        for (unsigned char i = 0; i < 16; i++)
        {
            ...
            {
                while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
                REG_ADDR32(REG_AUDIO_ANC_COEF(ANC_CHANNEL_SELECT) + 0x1280 + i * 0x20 + j * 4) = ((wz_fir_bypass[i + j * 32 + 16] << 16) & 0xFFFF0000) | (wz_fir_bypass[i + j * 32] & 0xFFFF);
            }
        }
 ...
 #if 1
    {
     ...
     //audio_anc_update_wcz_iir_coef(ANC_CHANNEL_SELECT, ANC0_WCZ1, cz_iir);  //cz0
     {
        ...
        reg_audio_anc_iir_start(ANC_CHANNEL_SELECT) = FLD_ANC_RZ0_IIR_START;
         ...
         {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_b0(ANC_CHANNEL_SELECT, ANC0_RZ0, i) = wz_iir_bypass[i][0];
             while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_b1(ANC_CHANNEL_SELECT, ANC0_RZ0, i) = wz_iir_bypass[i][1];
             while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_b2(ANC_CHANNEL_SELECT, ANC0_RZ0, i) = wz_iir_bypass[i][2];
             while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_a1(ANC_CHANNEL_SELECT, ANC0_RZ0, i) = wz_iir_bypass[i][3];
             while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_a2(ANC_CHANNEL_SELECT, ANC0_RZ0, i) = wz_iir_bypass[i][4];
         }
         delay_us(1);
         while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
         ...
         {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_b0(ANC_CHANNEL_SELECT, ANC0_RZ1, i) = wz_iir_bypass[i][0];
             while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_b1(ANC_CHANNEL_SELECT, ANC0_RZ1, i) = wz_iir_bypass[i][1];
             while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_b2(ANC_CHANNEL_SELECT, ANC0_RZ1, i) = wz_iir_bypass[i][2];
             while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_a1(ANC_CHANNEL_SELECT, ANC0_RZ1, i) = wz_iir_bypass[i][3];
             while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             reg_audio_anc_rz_iir_a2(ANC_CHANNEL_SELECT, ANC0_RZ1, i) = wz_iir_bypass[i][4];
         }
     }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        for (unsigned char i = 0; i < 16; i++)
        {
         ...
         {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
             REG_ADDR32(REG_AUDIO_ANC_COEF(ANC_CHANNEL_SELECT) + 0x1480 + 0x200 * ANC0_RZ0 + i * 0x20 + j * 4) = ((wz_fir_bypass[i + j * 32 + 16] << 16) & 0xFFFF0000) | (wz_fir_bypass[i + j * 32] & 0xFFFF);
         }
        }
        delay_us(1);
        while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
        ...
        for (unsigned char i = 0; i < 16; i++)
        {
          ...
          {
            while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
              REG_ADDR32(REG_AUDIO_ANC_COEF(ANC_CHANNEL_SELECT) + 0x1480 + 0x200 * ANC0_RZ1 + i * 0x20 + j * 4) = ((wz_fir_bypass[i + j * 32 + 16] << 16) & 0xFFFF0000) | (wz_fir_bypass[i + j * 32] & 0xFFFF);
          }
        }
     while(reg_audio_anc_config1(ANC_CHANNEL_SELECT) & FLD_ANC_FSM_STATUS){};
REG_ADDR16(REG_AUDIO_ANC_BASE(ANC_CHANNEL_SELECT) + 0x9e) = BIT(ANC0_WCZ0) | BIT(ANC0_WCZ1) | BIT(ANC0_WCZ2) | BIT(ANC0_WCZ3) | BIT(ANC0_WCZ0 + 8) | BIT(ANC0_WCZ1 + 8) | BIT(ANC0_WCZ2 + 8) | BIT(ANC0_WCZ3 + 8) |
    ...
    audio_anc_update_bz_iir_coef(ANC_CHANNEL_SELECT, ANC0_BZ0, wz_iir_bypass);
    audio_anc_update_bz_iir_coef(ANC_CHANNEL_SELECT, ANC0_BZ1, wz_iir_bypass);
    audio_anc_update_bz_iir_coef(ANC_CHANNEL_SELECT, ANC0_BZ2, wz_iir_bypass);
    audio_anc_update_bz_iir_coef(ANC_CHANNEL_SELECT, ANC0_BZ3, wz_iir_bypass);
    audio_anc_update_bz_iir_coef(ANC_CHANNEL_SELECT, ANC0_BZ4, wz_iir_bypass);
