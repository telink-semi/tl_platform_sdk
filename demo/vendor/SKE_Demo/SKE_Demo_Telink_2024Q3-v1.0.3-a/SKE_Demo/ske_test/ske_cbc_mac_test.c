...
unsigned int ske_cbc_mac_test_internal(SKE_ALG alg, unsigned char *std_key, unsigned short sp_key_idx, unsigned char mac_bytes, unsigned char *std_mac1, unsigned char *std_mac2, unsigned char *std_mac3)
{
    ...
    if (SKE_SUCCESS != ret || memcmp_(mac, (unsigned char *)std_mac1, mac_bytes)) {
        ...
        print_buf_U8(message, 3, "message");
        print_buf_U8((unsigned char *)std_key, ske_lp_get_key_byte_len(alg), "key");
        print_buf_U8(mac, mac_bytes, "mac");
        return 1;
    } else {
    ...
    for (i = 0; i < 500; i++) {
        ...
        //generate mac
        #if 1
    ret = ske_lp_cbc_mac(alg, SKE_GENERATE_MAC, SKE_ZERO_PADDING, (unsigned char *)std_key, sp_key_idx, message, 500, mac, mac_bytes);
        #else
    ret = ske_lp_cbc_mac_init(ctx, alg, SKE_GENERATE_MAC, SKE_ZERO_PADDING, (unsigned char *)std_key, sp_key_idx, mac_bytes);
    ...
    if (SKE_SUCCESS != ret || memcmp_(mac, (unsigned char *)std_mac2, mac_bytes)) {
        ...
        //verify mac
        #if 1
    ret = ske_lp_cbc_mac(alg, SKE_VERIFY_MAC, SKE_ZERO_PADDING, (unsigned char *)std_key, sp_key_idx, message, 500, mac, mac_bytes);
        #else
    ret = ske_lp_cbc_mac_init(ctx, alg, SKE_VERIFY_MAC, SKE_ZERO_PADDING, (unsigned char *)std_key, sp_key_idx, mac_bytes);
    ret |= ske_lp_cbc_mac_update(ctx, message, 500);
    ret |= ske_lp_cbc_mac_final(ctx, mac);
    ...
    if (SKE_SUCCESS != ret || memcmp_(message, (unsigned char *)std_mac3, mac_bytes)) {
        ...
        print_buf_U8((unsigned char *)std_mac3, mac_bytes, "std_mac3");
...
unsigned int ske_dma_cbc_mac_test_internal(SKE_ALG alg, unsigned char *std_key, unsigned short sp_key_idx, unsigned char mac_bytes, unsigned char *std_mac1, unsigned char *std_mac2, unsigned char *std_mac3)
{
    ...
    uint32_copy(msg, (unsigned int *)message, 1);
        ...
        #if 1
    ret = ske_lp_dma_cbc_mac(alg, (unsigned char *)std_key, sp_key_idx, msg, 3, tmp_out_, mac, mac_bytes, ske_call_manage);
        #else
    ...
    if (SKE_SUCCESS != ret || memcmp_((unsigned char *)std_mac1, mac, mac_bytes)) {
        ...
        print_buf_U8(message, 3, "message");
        print_buf_U8((unsigned char *)std_key, key_byte_len, "std_key");
    ...
    for (i = 1; i <= 500; i++) {
        ...
        ret |= ske_lp_dma_cbc_mac(alg, (unsigned char *)std_key, sp_key_idx, msg, i, tmp_out_, mac, mac_bytes, ske_call_manage);
...
unsigned char std_des_cbc_mac_key[16] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_des_cbc_mac_mac1[32] = {
    0x5B,
    0xD6,
    0x9A,
    0x24,
...
unsigned char std_des_cbc_mac_mac2[32] = {
    0x4B,
    0xE2,
    0xE8,
    0xBF,
...
unsigned char std_des_cbc_mac_mac3[32] = {
    0x66,
    0xEC,
    0x6C,
    0xEC,
...
unsigned char std_tdes_128_cbc_mac_key[16] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_tdes_128_cbc_mac_mac1[32] = {
    0x59,
    0xFB,
    0xBF,
    0x43,
...
unsigned char std_tdes_128_cbc_mac_mac2[32] = {
    0x8E,
    0x9C,
    0xF0,
    0x3E,
...
unsigned char std_tdes_128_cbc_mac_mac3[32] = {
    0x88,
    0x9C,
    0xA2,
    0xB4,
...
unsigned char std_tdes_192_cbc_mac_key[24] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_tdes_192_cbc_mac_mac1[32] = {
    0x6C,
    0xE5,
    0x29,
    0x3A,
...
unsigned char std_tdes_192_cbc_mac_mac2[32] = {
    0x91,
    0xFD,
    0x2B,
    0x62,
...
unsigned char std_tdes_192_cbc_mac_mac3[32] = {
    0xD0,
    0x7D,
    0xDD,
    0x33,
...
unsigned char std_tdes_eee_128_cbc_mac_key[16] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_tdes_eee_128_cbc_mac_mac1[32] = {
    0x2B,
    0x1B,
    0x36,
    0xD7,
...
unsigned char std_tdes_eee_128_cbc_mac_mac2[32] = {
    0xA5,
    0x18,
    0x3D,
    0xA7,
...
unsigned char std_tdes_eee_128_cbc_mac_mac3[32] = {
    0x27,
    0x9B,
    0x2F,
    0x7A,
...
unsigned int tdes_eee_128_cbc_mac_test(void)
{
    ...
    ret = ske_cbc_mac_test_internal(SKE_ALG_TDES_EEE_128, std_tdes_eee_128_cbc_mac_key, 0, 8, std_tdes_eee_128_cbc_mac_mac1, std_tdes_eee_128_cbc_mac_mac2, std_tdes_eee_128_cbc_mac_mac3);
    if (ret) {
        return 1;
    }
...
unsigned char std_tdes_eee_192_cbc_mac_key[24] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_tdes_eee_192_cbc_mac_mac1[32] = {
    0x98,
    0x36,
    0xC2,
    0x2A,
...
unsigned char std_tdes_eee_192_cbc_mac_mac2[32] = {
    0x94,
    0x0C,
    0xE5,
    0x4C,
...
unsigned char std_tdes_eee_192_cbc_mac_mac3[32] = {
    0xE6,
    0xF3,
    0xA6,
    0x52,
...
unsigned int tdes_eee_192_cbc_mac_test(void)
{
    ...
    ret = ske_cbc_mac_test_internal(SKE_ALG_TDES_EEE_192, std_tdes_eee_192_cbc_mac_key, 0, 8, std_tdes_eee_192_cbc_mac_mac1, std_tdes_eee_192_cbc_mac_mac2, std_tdes_eee_192_cbc_mac_mac3);
    if (ret) {
        return 1;
    }
...
unsigned char std_sm4_cbc_mac_key[16] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_sm4_cbc_mac_mac1[32] = {
    0x9A,
    0xE4,
    0xFF,
    0x00,
...
unsigned char std_sm4_cbc_mac_mac2[32] = {
    0x6F,
    0x09,
    0x74,
    0x75,
...
unsigned char std_sm4_cbc_mac_mac3[32] = {
    0x78,
    0x6B,
    0x06,
    0x7E,
...
unsigned char std_aes_128_cbc_mac_key[16] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_aes_128_cbc_mac_mac1[32] = {
    0x65,
    0xAD,
    0xFD,
    0x9E,
...
unsigned char std_aes_128_cbc_mac_mac2[32] = {
    0x90,
    0x9B,
    0x26,
    0xC0,
...
unsigned char std_aes_128_cbc_mac_mac3[32] = {
    0xBA,
    0xF7,
    0x0D,
    0x15,
...
unsigned char std_aes_192_cbc_mac_key[24] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_aes_192_cbc_mac_mac1[32] = {
    0xEB,
    0x13,
    0x69,
    0x2D,
...
unsigned char std_aes_192_cbc_mac_mac2[32] = {
    0xEB,
    0x27,
    0x6A,
    0x29,
...
unsigned char std_aes_192_cbc_mac_mac3[32] = {
    0xE9,
    0x30,
    0xE7,
    0xDF,
...
unsigned char std_aes_256_cbc_mac_key[32] = {
    0xE0,
    0x70,
    0x99,
    0xF1,
...
unsigned char std_aes_256_cbc_mac_mac1[32] = {
    0xF0,
    0xF0,
    0x26,
    0x3F,
...
unsigned char std_aes_256_cbc_mac_mac2[32] = {
    0xA7,
    0xAE,
    0x27,
    0x71,
...
unsigned char std_aes_256_cbc_mac_mac3[32] = {
    0xC0,
    0xA4,
    0x43,
    0xEB,
