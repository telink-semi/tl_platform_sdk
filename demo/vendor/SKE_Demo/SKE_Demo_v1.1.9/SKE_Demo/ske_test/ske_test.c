...
unsigned int SKE_test(SKE_ALG ske_alg, SKE_MODE mode, unsigned char wordAlign,  unsigned char *std_plain,
                unsigned int byteLen,  unsigned char *key, unsigned short key_id,  unsigned char *iv,  unsigned char *std_cipher)
{
    unsigned int i,j;
...
unsigned int SKE_DMA_test(SKE_ALG ske_alg, SKE_MODE mode, unsigned char *std_plain,
                unsigned int wordLen, unsigned char *key, unsigned short key_id, unsigned char *iv,  unsigned char *std_cipher)
{
    unsigned int i,j;
