...
unsigned int ske_cmac_test_internal(SKE_ALG alg,  unsigned char *std_key, unsigned short sp_key_idx, unsigned char mac_bytes, 
         unsigned char *std_mac1,  unsigned char *std_mac2,  unsigned char *std_mac3)
{
    ...
    {// print_buf_U8(message, 500, "message");
        ...
        if(SKE_SUCCESS != ret || memcmp_(mac, std_mac2, mac_bytes))
        {
            printf("\r\n %s generate CMAC test 2-%x failure, ret=%x \r\n", name[alg], i+2, ret);
            print_buf_U8(mac, mac_bytes, "digest");
            return 1;
        }
        else
        {
            printf("\r\n %s generate CMAC test 2-%x success ", name[alg], i+2);
        }
        ...
        if(SKE_SUCCESS != ret)
        {
            printf("\r\n %s verify CMAC test 2-%x failure, ret=%x \r\n", name[alg], i+2, ret);
            print_buf_U8(mac, mac_bytes, "digest");
            return 1;
        }
        else
        {
            printf("\r\n %s verify CMAC test 2-%x success ", name[alg], i+2);
        }
    }
...
unsigned int ske_dma_cmac_test_internal(SKE_ALG alg,  unsigned char *std_key, unsigned short sp_key_idx, unsigned char mac_bytes,
         unsigned char *std_mac1,  unsigned char *std_mac2,  unsigned char *std_mac3)
{
...
//the two styles are equivalent
    ...
    {
        printf("\r\n %s CMAC DMA test 1 success ", name[alg]); fflush(stdout);
    }
...
//the two styles are equivalent
    ...
    {
        printf("\r\n %s CMAC DMA test 2 success ", name[alg]);fflush(stdout);
    }
 ...
 unsigned char std_des_cmac_key[16]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,};
 unsigned char std_des_cmac_mac1[32] =  {0xEE,0x3F,0x70,0x7F,0x2C,0x11,0xD2,0x97,};
 unsigned char std_des_cmac_mac2[32] =  {0x86,0xED,0x2F,0x12,0x41,0xAC,0xFB,0x6B,};
 unsigned char std_des_cmac_mac3[32] =  {0x76,0xC2,0x62,0x68,0xEC,0xC8,0x3B,0x46,};

unsigned int des_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_DES, std_des_cmac_key, 0, 8,
        std_des_cmac_mac1, std_des_cmac_mac2, std_des_cmac_mac3);
    if(ret)
        return 1;

#ifdef SKE_LP_DMA_FUNCTION
    ret = ske_dma_cmac_test_internal(SKE_ALG_DES, std_des_cmac_key, 0, 8,
        std_des_cmac_mac1, std_des_cmac_mac2, std_des_cmac_mac3);
    if(ret)
        return 1;
#endif
...
//*
 ...
 unsigned char std_tdes_128_cmac_key[16]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,0x24,0x0C,0xD7,0x90,0xCA,0x4F,0xE1,0x34,};
 unsigned char std_tdes_128_cmac_mac1[32] =  {0x38,0xB0,0xCD,0xE0,0x48,0xEC,0x42,0x38,};
 unsigned char std_tdes_128_cmac_mac2[32] =  {0xCD,0x69,0xB5,0x7D,0xFC,0x59,0x19,0xF7,};
 unsigned char std_tdes_128_cmac_mac3[32] =  {0x64,0x94,0x6D,0x98,0xA9,0xBE,0xAC,0x56,};

unsigned int tdes_128_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_TDES_128, std_tdes_128_cmac_key, 0, 8,
...
*/
 ...
 unsigned char std_tdes_192_cmac_key[24]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,0x24,0x0C,0xD7,0x90,0xCA,0x4F,0xE1,0x34,
                                             0xB4,0x42,0x60,0xE1,0x56,0x8D,0x9E,0x85,};
 unsigned char std_tdes_192_cmac_mac1[32] =  {0x11,0x3A,0x81,0xAF,0x89,0x94,0x2E,0xB6,};
 unsigned char std_tdes_192_cmac_mac2[32] =  {0x04,0x9C,0x81,0x2B,0x10,0xFA,0xFC,0xB6,};
 unsigned char std_tdes_192_cmac_mac3[32] =  {0xB7,0x82,0x0B,0x62,0x22,0x77,0xB4,0xCA,};

unsigned int tdes_192_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_TDES_192, std_tdes_192_cmac_key, 0, 8, 
...
*/
 ...
 unsigned char std_tdes_eee_128_cmac_key[16]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,0x24,0x0C,0xD7,0x90,0xCA,0x4F,0xE1,0x34,};
 unsigned char std_tdes_eee_128_cmac_mac1[32] =  {0xD6,0x08,0x2A,0x8E,0x6F,0x2E,0x76,0x90,};
 unsigned char std_tdes_eee_128_cmac_mac2[32] =  {0xE1,0x30,0x43,0x47,0x75,0x1B,0x9E,0x7B,};
 unsigned char std_tdes_eee_128_cmac_mac3[32] =  {0x58,0xCA,0x6C,0x94,0x16,0x0A,0xB6,0x76,};

unsigned int tdes_eee_128_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_TDES_EEE_128, std_tdes_eee_128_cmac_key, 0, 8, 
...
*/
 ...
 unsigned char std_tdes_eee_192_cmac_key[24]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,0x24,0x0C,0xD7,0x90,0xCA,0x4F,0xE1,0x34,
                                                0xB4,0x42,0x60,0xE1,0x56,0x8D,0x9E,0x85,};
 unsigned char std_tdes_eee_192_cmac_mac1[32] =  {0xB1,0x35,0x3C,0x97,0xA4,0x7C,0x14,0x2B,};
 unsigned char std_tdes_eee_192_cmac_mac2[32] =  {0xC3,0x8A,0x12,0x10,0x1B,0xCB,0x45,0xBC,};
 unsigned char std_tdes_eee_192_cmac_mac3[32] =  {0xA4,0x55,0x52,0x0B,0xAB,0xEE,0x65,0x7E,};

unsigned int tdes_eee_192_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_TDES_EEE_192, std_tdes_eee_192_cmac_key, 0, 8, 
...
//*/
 ...
 unsigned char std_sm4_cmac_key[16]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,0x24,0x0C,0xD7,0x90,0xCA,0x4F,0xE1,0x34,};
 unsigned char std_sm4_cmac_mac1[32] =  {0xAF,0xCD,0xA8,0xC2,0x78,0x0C,0x13,0xC0,0x4E,0x77,0x2D,0x51,0x55,0x4A,0x0E,0xE7,};
 unsigned char std_sm4_cmac_mac2[32] =  {0xA2,0x78,0x67,0x2F,0x7F,0xFE,0xE4,0x15,0xBB,0xA9,0x03,0xE7,0x5F,0x4D,0xB4,0x9E,};
 unsigned char std_sm4_cmac_mac3[32] =  {0x4C,0x44,0xA4,0xFE,0xFF,0xEE,0x02,0x34,0xE4,0x34,0xA6,0x8E,0x6D,0xBC,0x0C,0xAE,};

unsigned int sm4_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_SM4, std_sm4_cmac_key, 0, 16, std_sm4_cmac_mac1, 
        std_sm4_cmac_mac2, std_sm4_cmac_mac3);
    if(ret)
        return 1;

#ifdef SKE_LP_DMA_FUNCTION
    ret = ske_dma_cmac_test_internal(SKE_ALG_SM4, std_sm4_cmac_key, 0, 16, std_sm4_cmac_mac1,
        std_sm4_cmac_mac2, std_sm4_cmac_mac3);
    if(ret)
        return 1;
#endif
 ...
 unsigned char std_aes_128_cmac_key[16]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,0x24,0x0C,0xD7,0x90,0xCA,0x4F,0xE1,0x34,};
 unsigned char std_aes_128_cmac_mac1[32] =  {0x49,0xE2,0x30,0x8A,0x22,0x8C,0x43,0xFF,0xED,0x99,0x87,0xD4,0x75,0x8B,0xAC,0xDC,};
 unsigned char std_aes_128_cmac_mac2[32] =  {0x45,0x1B,0xDF,0x99,0xD5,0x00,0xD5,0xAF,0xDE,0xFE,0xEE,0x44,0x18,0xC1,0x32,0x73,};
 unsigned char std_aes_128_cmac_mac3[32] =  {0xEC,0x5E,0xEB,0x22,0x66,0xE2,0x0A,0x55,0x34,0xD4,0x83,0xB0,0x83,0xF6,0x70,0xC4,};

unsigned int aes128_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_AES_128, std_aes_128_cmac_key, 0, 16, std_aes_128_cmac_mac1, 
        std_aes_128_cmac_mac2, std_aes_128_cmac_mac3);
    if(ret)
        return 1;

#ifdef SKE_LP_DMA_FUNCTION
    ret = ske_dma_cmac_test_internal(SKE_ALG_AES_128, std_aes_128_cmac_key, 0, 16, std_aes_128_cmac_mac1,
        std_aes_128_cmac_mac2, std_aes_128_cmac_mac3);
    if(ret)
        return 1;
#endif
 ...
 unsigned char std_aes_192_cmac_key[24]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,0x24,0x0C,0xD7,0x90,0xCA,0x4F,0xE1,0x34,
                                            0xB4,0x42,0x60,0xE1,0x56,0x8D,0x9E,0x85,};
 unsigned char std_aes_192_cmac_mac1[32] =  {0x98,0x90,0x68,0xAD,0x5E,0x5B,0x14,0x5E,0x89,0xC2,0x40,0x1B,0x3B,0x44,0x36,0x6A,};
 unsigned char std_aes_192_cmac_mac2[32] =  {0xBF,0x83,0xD7,0xAA,0x65,0x06,0xFE,0x44,0x08,0x23,0x9A,0xD1,0x6C,0x2D,0x1B,0x44,};
 unsigned char std_aes_192_cmac_mac3[32] =  {0x1A,0x6C,0x81,0xC2,0x2B,0x13,0xCA,0xB7,0x1A,0x8C,0x4C,0xC6,0xD4,0xF4,0xFC,0x0D,};

unsigned int aes192_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_AES_192, std_aes_192_cmac_key, 0, 16, std_aes_192_cmac_mac1, 
        std_aes_192_cmac_mac2, std_aes_192_cmac_mac3);
    if(ret)
        return 1;

#ifdef SKE_LP_DMA_FUNCTION
    ret = ske_dma_cmac_test_internal(SKE_ALG_AES_192, std_aes_192_cmac_key, 0, 16, std_aes_192_cmac_mac1,
        std_aes_192_cmac_mac2, std_aes_192_cmac_mac3);
    if(ret)
        return 1;
#endif
 ...
 unsigned char std_aes_256_cmac_key[32]  =  {0xE0,0x70,0x99,0xF1,0xBF,0xAF,0xFD,0x7F,0x24,0x0C,0xD7,0x90,0xCA,0x4F,0xE1,0x34,
                                            0xB4,0x42,0x60,0xE1,0x56,0x8D,0x9E,0x85,0x0A,0x0C,0x95,0x37,0x44,0x02,0xDE,0x28,};
 unsigned char std_aes_256_cmac_mac1[32] =  {0x14,0x7A,0xD3,0x82,0xAC,0xBD,0x2D,0xB4,0x69,0x85,0x87,0xEF,0x44,0xD2,0xF1,0x8B,};
 unsigned char std_aes_256_cmac_mac2[32] =  {0x87,0xBA,0x77,0xA2,0xFF,0x29,0xC3,0x69,0xAC,0x4D,0xAF,0x6B,0xAA,0x69,0xC7,0x39,};
 unsigned char std_aes_256_cmac_mac3[32] =  {0x67,0x1D,0x20,0x4B,0xCE,0xE4,0x42,0x2B,0x97,0xF2,0xE6,0xB3,0x3F,0x9B,0x04,0xDF,};

unsigned int aes256_cmac_test(void)
{
    unsigned int ret;

    ret = ske_cmac_test_internal(SKE_ALG_AES_256, std_aes_256_cmac_key, 0, 16, std_aes_256_cmac_mac1, 
        std_aes_256_cmac_mac2, std_aes_256_cmac_mac3);
    if(ret)
        return 1;

#ifdef SKE_LP_DMA_FUNCTION
    ret = ske_dma_cmac_test_internal(SKE_ALG_AES_256, std_aes_256_cmac_key, 0, 16, std_aes_256_cmac_mac1,
        std_aes_256_cmac_mac2, std_aes_256_cmac_mac3);
    if(ret)
        return 1;
#endif
...
unsigned int ske_cmac_speed_test_internal(SKE_ALG alg, char *info)
{
    ...
    if(SKE_SUCCESS != ret)
    {
        printf("\r\n cmac init error ret=%x", ret); fflush(stdout);
        return 1;
    }
    ...
    for(i=0;i<round;i++)
    {
        ...
        if(SKE_SUCCESS != ret)
        {
            printf("\r\n cmac crypto error ret=%x", ret); fflush(stdout);
            return 1;
        }
    }
    ...
    if(SKE_SUCCESS != ret)
    {
        printf("\r\n cmac final error ret=%x", ret); fflush(stdout);
        return 1;
    }
...
{
#if defined(SUPPORT_SKE_MODE_CBC_MAC)
    ske_cmac_speed_test_internal(SKE_ALG_DES, "SKE_ALG_DES CMAC");
#endif
#if defined(SUPPORT_SKE_TDES_192)
...
unsigned int ske_dma_cmac_speed_test_internal(SKE_ALG alg, char *info)
{
    ...
    if(SKE_SUCCESS != ret)
    {
        printf("\r\n dma cmac init error ret=%x", ret); fflush(stdout);
        return 1;
    }
    ...
    for(i=0;i<round;i++)
    {
        ...
        if(SKE_SUCCESS != ret)
        {
            printf("\r\n dma cmac crypto 1 error ret=%x", ret); fflush(stdout);
            return 1;
        }
    }
    ...
    if(SKE_SUCCESS != ret)
    {
        printf("\r\n dma cmac crypto 2 error ret=%x", ret); fflush(stdout);
        return 1;
    }
