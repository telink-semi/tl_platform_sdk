...
const unsigned char std_des_cbc_mac_mac1[32] = {
    0x5B, 0xD6, 0x9A, 0x24, 0xE0, 0xBC, 0x07, 0xCF,
};
const unsigned char std_des_cbc_mac_mac2[32] = {
    0x4B, 0xE2, 0xE8, 0xBF, 0x2D, 0xA8, 0x94, 0xE4,
};
const unsigned char std_des_cbc_mac_mac3[32] = {
    0x66, 0xEC, 0x6C, 0xEC, 0xA0, 0x00, 0x77, 0xB3,
};
...
const unsigned char std_tdes_128_cbc_mac_mac1[32] = {
    0x59, 0xFB, 0xBF, 0x43, 0x09, 0xDB, 0xBD, 0xE8,
};
const unsigned char std_tdes_128_cbc_mac_mac2[32] = {
    0x8E, 0x9C, 0xF0, 0x3E, 0x98, 0x0A, 0x8C, 0x72,
};
const unsigned char std_tdes_128_cbc_mac_mac3[32] = {
    0x88, 0x9C, 0xA2, 0xB4, 0x06, 0x36, 0x14, 0x3E,
};
...
const unsigned char std_tdes_192_cbc_mac_mac1[32] = {
    0x6C, 0xE5, 0x29, 0x3A, 0xA5, 0x83, 0x0E, 0xE1,
};
const unsigned char std_tdes_192_cbc_mac_mac2[32] = {
    0x91, 0xFD, 0x2B, 0x62, 0x82, 0xB0, 0x96, 0x8B,
};
const unsigned char std_tdes_192_cbc_mac_mac3[32] = {
    0xD0, 0x7D, 0xDD, 0x33, 0x02, 0x50, 0xE6, 0xAB,
};
...
const unsigned char std_tdes_eee_128_cbc_mac_mac1[32] = {
    0x2B, 0x1B, 0x36, 0xD7, 0x08, 0x63, 0xA3, 0x48,
};
const unsigned char std_tdes_eee_128_cbc_mac_mac2[32] = {
    0xA5, 0x18, 0x3D, 0xA7, 0x66, 0x4B, 0xB4, 0x13,
};
const unsigned char std_tdes_eee_128_cbc_mac_mac3[32] = {
    0x27, 0x9B, 0x2F, 0x7A, 0x7F, 0x4B, 0x11, 0xAD,
};
...
const unsigned char std_tdes_eee_192_cbc_mac_mac1[32] = {
    0x98, 0x36, 0xC2, 0x2A, 0x73, 0x4A, 0x0F, 0xE5,
};
const unsigned char std_tdes_eee_192_cbc_mac_mac2[32] = {
    0x94, 0x0C, 0xE5, 0x4C, 0x91, 0x52, 0x3D, 0x30,
};
const unsigned char std_tdes_eee_192_cbc_mac_mac3[32] = {
    0xE6, 0xF3, 0xA6, 0x52, 0xFE, 0x99, 0xFC, 0x12,
};
...
const unsigned char std_sm4_cbc_mac_mac1[32] = {
    0x9A, 0xE4, 0xFF, 0x00, 0xE6, 0xD1, 0x43, 0x32, 0xEC, 0xA0, 0xF8, 0x67, 0xA8, 0xE9, 0x48, 0xF3,
};
const unsigned char std_sm4_cbc_mac_mac2[32] = {
    0x6F, 0x09, 0x74, 0x75, 0xE4, 0xF9, 0xAF, 0x13, 0x8D, 0x23, 0xD2, 0xBA, 0xD5, 0xA8, 0xE1, 0x20,
};
const unsigned char std_sm4_cbc_mac_mac3[32] = {
    0x78, 0x6B, 0x06, 0x7E, 0xB5, 0x80, 0x91, 0xBE, 0xFB, 0xE2, 0x57, 0x12, 0x5F, 0xD2, 0x7B, 0xF0,
};
...
const unsigned char std_aes_128_cbc_mac_mac1[32] = {
    0x65, 0xAD, 0xFD, 0x9E, 0xA2, 0xA1, 0xCF, 0x12, 0xDB, 0x92, 0xD4, 0x31, 0xE3, 0xB7, 0x43, 0xF6,
};
const unsigned char std_aes_128_cbc_mac_mac2[32] = {
    0x90, 0x9B, 0x26, 0xC0, 0x89, 0x90, 0x91, 0x8A, 0xD2, 0x54, 0xAD, 0xF8, 0x66, 0x17, 0xF6, 0x24,
};
const unsigned char std_aes_128_cbc_mac_mac3[32] = {
    0xBA, 0xF7, 0x0D, 0x15, 0x8A, 0xA9, 0x3C, 0x02, 0x10, 0xBB, 0x4B, 0x34, 0xC6, 0xB4, 0xE9, 0xE8,
};
...
const unsigned char std_aes_192_cbc_mac_mac1[32] = {
    0xEB, 0x13, 0x69, 0x2D, 0x16, 0xAA, 0xDA, 0xE9, 0x05, 0x95, 0x77, 0x91, 0x2C, 0x88, 0x18, 0xFD,
};
const unsigned char std_aes_192_cbc_mac_mac2[32] = {
    0xEB, 0x27, 0x6A, 0x29, 0x40, 0xB1, 0x3D, 0xAE, 0x1F, 0xE7, 0x71, 0x9E, 0x4B, 0xB6, 0x28, 0xBA,
};
const unsigned char std_aes_192_cbc_mac_mac3[32] = {
    0xE9, 0x30, 0xE7, 0xDF, 0x83, 0xDA, 0xF7, 0x97, 0x4C, 0x66, 0xE8, 0x24, 0xFE, 0xBC, 0x0D, 0x1B,
};
...
const unsigned char std_aes_256_cbc_mac_mac1[32] = {
    0xF0, 0xF0, 0x26, 0x3F, 0x5C, 0x21, 0x8A, 0x51, 0x27, 0xC8, 0x94, 0x8F, 0x82, 0x24, 0xB1, 0x78,
};
const unsigned char std_aes_256_cbc_mac_mac2[32] = {
    0xA7, 0xAE, 0x27, 0x71, 0xCA, 0x6E, 0xCF, 0x49, 0xDF, 0x02, 0x13, 0x86, 0xCA, 0x62, 0xAE, 0x7F,
};
const unsigned char std_aes_256_cbc_mac_mac3[32] = {
    0xC0, 0xA4, 0x43, 0xEB, 0xFA, 0x7B, 0xCE, 0xDF, 0x18, 0xAB, 0x1B, 0xB6, 0x7F, 0x70, 0xD2, 0x5E,
};
