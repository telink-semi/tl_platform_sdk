...
{
    analog_write_reg8(areg_0x10d, ((analog_read_reg8(areg_0x10d) & (~FLD_AUDIO_PGAVOL_IN)) | MASK_VAL(FLD_AUDIO_PGAVOL_IN, pga_gain)));
}
...
static inline codec_in_pga_gain_e audio_get_adc_pga_gain(void)
{
    ...
    val = (analog_read_reg8(areg_0x10d) & FLD_AUDIO_PGAVOL_IN) >> 4;
    return val;
}
