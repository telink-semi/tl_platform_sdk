...
enum
{
    ...
    //RSVD
    FLD_AUTO_PD_24M_XTAL           = BIT(3),
    FLD_AUTO_PD_LOGIC              = BIT(4),
    FLD_AUTO_PD_DCDC               = BIT(5),
    FLD_AUTO_PD_VBUS_LDO           = BIT(6),
    FLD_AUTO_PD_ANA_BBPLL_TEMP_LDO = BIT(7),
    FLD_AUTO_PD_LPC                = BIT(8),
    //RSVD
    FLD_AUTO_PD_UVLO_IB            = BIT(10), //Cannot be turned off during sleep.
                                         //Here the configuration set to 1 also works because the configuration is invalid.
    FLD_AUTO_PD_VBUS_SW            = BIT(11),
    //RSVD
    //RSVD
    FLD_PD_SEQUENCE_EN             = BIT(14),
    FLD_EN_ISOLATION               = BIT(15),
};
