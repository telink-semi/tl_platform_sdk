...
enum{
    FLD_PWM_PEM_EVENT_SEL = BIT_RNG(0,1),
    FLD_PWM_PEM_EVENT_EN  = BIT(2),
    FLD_PWM_PEM_TASK_SEL  = BIT(3),
 ...
 * BIT[0]:This bit is usually used with BIT[0] of 0x140e12. If this bit is set to 1, it means that a pulse group of PWM has been sent.An interrupt was also generated. You can manually write 1 to clear the interrupt flag.
 ...
 * BIT[2]:When the FIFO value is less than the set value, an interrupt is generated(The premise is that this interrupt has been enabled by register 0x140e12 previous).
 *        The user can know whether this interrupt is generated by reading the status of this register.If BIT(2):1 Indicates that this interrupt has been generated.
 */
#define reg_pwm_int            REG_ADDR8(REG_PWM_BASE+0x16)

#define reg_pwm_task_en        REG_ADDR8(REG_PWM_BASE+0x17)

/**
 * BIT[0]~BIT[23]:If this is set 1 Indicates that a signal frame interrupt has been generated. You can manually write 1 to clear the interrupt flag.
 */
#define reg_pwm_irq_sta        REG_ADDR32(REG_PWM_BASE+0x18)
enum{
    FLD_PWM0_FRAME_DONE_IRQ   = BIT(0),
    FLD_PWM1_FRAME_DONE_IRQ   = BIT(1),
    FLD_PWM2_FRAME_DONE_IRQ   = BIT(2),
    FLD_PWM3_FRAME_DONE_IRQ   = BIT(3),
    FLD_PWM4_FRAME_DONE_IRQ   = BIT(4),
    FLD_PWM5_FRAME_DONE_IRQ   = BIT(5),
    FLD_PWM6_FRAME_DONE_IRQ   = BIT(6),
...
enum{
     ...
     FLD_PWM_IRQ_CYCDONE_MASK    =    BIT(6),
};
