 ...
 * @return      none.
 */
static _always_inline void stimer_set_irq_mask_d25f(stimer_irq_mask_d25f_e mask)
{
    reg_system_irq_mask_d25f |= mask;
}
 ...
 * @return      none.
 */
static _always_inline void stimer_set_irq_mask_n22(stimer_irq_mask_n22_e mask)
{
    reg_system_irq_mask_n22 |= mask;
}
 ...
 * @return      none.
 */
static _always_inline void stimer_clr_irq_mask_d25f(stimer_irq_mask_d25f_e mask)
{
    reg_system_irq_mask_d25f &= (~mask);
}
 ...
 * @return      none.
 */
static _always_inline void stimer_clr_irq_status_d25f(stimer_irq_status_e status)
{
    reg_system_cal_irq_d25f = (status);
}
 ...
 * @return      none.
 */
static _always_inline void stimer_clr_irq_status_n22(void)
{
    reg_system_irq_n22 = FLD_SYSTEM_IRQ_N22;
}
 ...
 */
static _always_inline unsigned char stimer_get_irq_status_d25f(stimer_irq_status_e status)
{
    return (reg_system_cal_irq_d25f & status);
}
 ...
 * @retval      zero  -  the interrupt did not occur.
 */
static _always_inline unsigned char stimer_get_irq_status_n22(void)
{
    return (reg_system_irq_n22 & FLD_SYSTEM_IRQ_N22);
}
