...
typedef enum
{
    NVM_MTP_LOCK_NONE     = 0x00, //000000h-000000h
    NVM_MTP_LOCK_LOW_4K   = 0x01, //000000h-000FFFh
    NVM_MTP_LOCK_LOW_8K   = 0x02, //000000h-001FFFh
    NVM_MTP_LOCK_LOW_16K  = 0x04, //000000h-003FFFh
    NVM_MTP_LOCK_LOW_32K  = 0x08, //000000h-007FFFh
    NVM_MTP_LOCK_LOW_64K  = 0x10, //000000h-00FFFFh
    NVM_MTP_LOCK_LOW_128K = 0x20, //000000h-01FFFFh
    NVM_MTP_LOCK_LOW_256K = 0x40, //000000h-03EFFFh
    NVM_MTP_LOCK_LOW_512K = 0x80, //000000h-07FFFFh
    NVM_MTP_LOCK_ALL_512K = 0x80, //000000h-07FFFFh
} nvm_mtp_lock_block_e;

typedef enum
{
    NVM_CR_OTP_LOCK_NONE    = 0x00, //000000h-000000h
    NVM_CR_OTP_LOCK_0K_4K   = 0x01, //000000h-000FFFh
    NVM_CR_OTP_LOCK_4K_8K   = 0x02, //001000h-001FFFh
    NVM_CR_OTP_LOCK_8K_12K  = 0x04, //002000h-002FFFh
    NVM_CR_OTP_LOCK_12K_16K = 0x08, //003000h-003FFFh
    NVM_CR_OTP_LOCK_16K_20K = 0x10, //004000h-004FFFh
    NVM_CR_OTP_LOCK_20K_24K = 0x20, //005000h-005FFFh
    NVM_CR_OTP_LOCK_ALL_24K = 0x3F, //000000h-005FFFh
} nvm_cr_otp_lock_block_e;

typedef enum
{
    NVM_CC_OTP_LOCK_NONE     = 0x0000, //006000h-000000h
    NVM_CC_OTP_LOCK_0_63     = 0x0001, //006000h-00603Fh
    NVM_CC_OTP_LOCK_64_127   = 0x0002, //006040h-00607Fh
    NVM_CC_OTP_LOCK_128_191  = 0x0004, //006080h-0060BFh
    NVM_CC_OTP_LOCK_192_255  = 0x0008, //0060C0h-0060FFh
    NVM_CC_OTP_LOCK_256_319  = 0x0010, //006100h-00613Fh
    NVM_CC_OTP_LOCK_320_383  = 0x0020, //006140h-00617Fh
    NVM_CC_OTP_LOCK_384_447  = 0x0040, //006180h-0061BFh
    NVM_CC_OTP_LOCK_448_511  = 0x0080, //0061C0h-0061FFh
    NVM_CC_OTP_LOCK_512_575  = 0x0100, //006200h-00623Fh
    NVM_CC_OTP_LOCK_576_639  = 0x0200, //006240h-00627Fh
    NVM_CC_OTP_LOCK_640_703  = 0x0400, //006280h-0062BFh
    NVM_CC_OTP_LOCK_704_767  = 0x0800, //0062C0h-0062FFh
    NVM_CC_OTP_LOCK_768_831  = 0x1000, //006300h-00633Fh
    NVM_CC_OTP_LOCK_832_895  = 0x2000, //006340h-00637Fh
    NVM_CC_OTP_LOCK_896_959  = 0x4000, //006380h-0063BFh
    NVM_CC_OTP_LOCK_960_1023 = 0x8000, //0063C0h-0063FFh
    NVM_CC_OTP_LOCK_ALL_1024 = 0xFFFF, //006000h-0063FFh
} nvm_cc_otp_lock_block_e;
...
/**
 * @brief       This function is used to set the NVM MTP lock area.
 * @param[in]   lock_area - the lock area to set (e.g., NVM_MTP_LOCK_LOW_16K, NVM_MTP_LOCK_LOW_32K).
 * @return      none.
 */ 
void nvm_mtp_lock_set(nvm_mtp_lock_block_e lock_area);