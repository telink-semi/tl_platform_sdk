...
//APIs for user.
void SHA512_Init_with_iv_and_updated_length (SHA512_Ctx *ctx, unsigned char iv[64],
...
void SHA384_Init_with_iv_and_updated_length (SHA384_Ctx *ctx, unsigned char iv[64],
        unsigned int byte_length_h, unsigned int byte_length_l);
...
void SHA512_224_Init_with_iv_and_updated_length (SHA512_224_Ctx *ctx, unsigned char iv[64],
        unsigned int byte_length_h, unsigned int byte_length_l);
...
void SHA512_256_Init_with_iv_and_updated_length (SHA512_256_Ctx *ctx, unsigned char iv[64],
        unsigned int byte_length_h, unsigned int byte_length_l);
