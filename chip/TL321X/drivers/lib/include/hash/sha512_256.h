 ...
 * @note
  ...
  @endverbatim
  */
unsigned int sha512_256_dma_final(SHA512_256_DMA_CTX *ctx, unsigned int *remainder_msg, unsigned int remainder_bytes, 
        unsigned int *digest);
...
unsigned int sha512_256_dma_node_steps(HASH_DMA_NODE *node, unsigned int node_num, unsigned int *digest, 
