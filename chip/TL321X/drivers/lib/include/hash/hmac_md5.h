 ...
 * @return      0:success     other:error
 */
unsigned int hmac_md5_dma_init(HMAC_MD5_DMA_CTX *ctx, unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes,
 ...
 * @return       0:success     other:error
 */
unsigned int hmac_md5_dma(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, unsigned int *msg, 
