 ...
 * @note
  ...
  @endverbatim
 */
unsigned int hmac_sha256(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, unsigned char *msg, 
 ...
 * @note
  ...
  @endverbatim
 */
unsigned int hmac_sha256_node_steps(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, 
 ...
 * @return      0:success     other:error
 */
unsigned int hmac_sha256_dma_init(HMAC_SHA256_DMA_CTX *ctx, unsigned char *key, unsigned short sp_key_idx,
 ...
 * @return      0:success     other:error
 */
unsigned int hmac_sha256_dma(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, unsigned int *msg, 
...
unsigned int hmac_sha256_dma_node_steps(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, 
