...
unsigned int hmac_sha384(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, unsigned char *msg, 
...
unsigned int hmac_sha384_node_steps(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, 
        HASH_NODE *node, unsigned int node_num, unsigned char *mac);
#endif


#ifdef HASH_DMA_FUNCTION
unsigned int hmac_sha384_dma_init(HMAC_SHA384_DMA_CTX *ctx, unsigned char *key, unsigned short sp_key_idx,
        unsigned int key_bytes, HASH_CALLBACK callback);

#ifdef CONFIG_HASH_SUPPORT_ADDRESS_HIGH_LOW
unsigned int hmac_sha384_dma_update_blocks(HMAC_SHA384_DMA_CTX *ctx, unsigned int msg_h, unsigned int msg_l, 
        unsigned int msg_bytes);

unsigned int hmac_sha384_dma_final(HMAC_SHA384_DMA_CTX *ctx, unsigned int remainder_msg_h, unsigned int remainder_msg_l, 
        unsigned int remainder_bytes, unsigned int mac_h, unsigned int mac_l);

unsigned int hmac_sha384_dma(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, unsigned int msg_h, 
        unsigned int msg_l, unsigned int msg_bytes, unsigned int mac_h, unsigned int mac_l, HASH_CALLBACK callback);

#ifdef SUPPORT_HASH_DMA_NODE
unsigned int hmac_sha384_dma_node_steps(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, 
...
unsigned int hmac_sha384_dma(unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, unsigned int *msg, 
