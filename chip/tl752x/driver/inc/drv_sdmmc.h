...
/*********************  Bit definition for SDMMC register  ********************/
...
/* CARDTHRCTL - Card Threshold Control */
...
typedef void (*sdio_isr_cbk_t)(void);

extern void drv_sdmmc_isr_register(sdio_isr_cbk_t cbk);
extern void drv_sdmmc_isr_unregister(void);
