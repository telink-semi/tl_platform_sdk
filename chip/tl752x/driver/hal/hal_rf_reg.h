...
#ifndef __HAL_RF_REG_H__
#define __HAL_RF_REG_H__
#include "bit.h"
#include "inc/soc.h"



#define ZB_AHBADDR      0x50425000
#define SPL_AHBADDR     0x50426000


#define BBCTRL_BASE     ZB_AHBADDR+0x000
#define BBLL_BASE       ZB_AHBADDR+0x200
#define BBPDZB_BASE     ZB_AHBADDR+0x300
#define MODEM_BASE      ZB_AHBADDR+0x400
#define RADIO_BASE      ZB_AHBADDR+0x600
#define DMABB_BASE      ZB_AHBADDR+0x800
#define SCBB_BASE       ZB_AHBADDR+0xc00


#define SPLBB_BASE      SPL_AHBADDR+0x000
#define SPLLL_BASE      SPL_AHBADDR+0x100
#define SPLDMA_BASE     SPL_AHBADDR+0x200


#define RADIOADDR       ZB_AHBADDR+0x600
#define MODEMADDR       ZB_AHBADDR+0x400
#define BBADDR          ZB_AHBADDR
#define LLADDR          ZB_AHBADDR + 0x200


#define CHNADDR         (ZB_AHBADDR + 0x800)
#define RXCHN           1
#define TXCHN           0
#define RXCHNADDR       (CHNADDR + 0x44 + RXCHN * 0x14)
#define TXCHNADDR       (CHNADDR + 0x44 + TXCHN * 0x14)
#define RXDMA_DATA      (BBADDR + 0x80)
#define TXDMA_DATA      (BBADDR + 0x84)
#define DMA10C          (CHNADDR + 0x10c)
#define DMAF0           (CHNADDR + 0xf0)


#define RXADDR          0x50090000  // channel 1
#define TXADDR          0x50091000  // channel 0
#define TXLLPADDR       0xc0002000
#define RXLLPADDR       0xc0002020


// Unified macro definitions (all at file header)
#define ZB_AHBADDR_50425000      0x50425000
#define ZB_AHBADDR_50001000      0x50001000
#define SPL_AHBADDR_50002000     0x50002000

// Derived addresses for ZB_AHBADDR_50425000
#define RADIOADDR_50425000       (ZB_AHBADDR_50425000 + 0x600)
#define MODEMADDR_50425000       (ZB_AHBADDR_50425000 + 0x400)
#define BBADDR_50425000          ZB_AHBADDR_50425000
#define LLADDR_50425000          (ZB_AHBADDR_50425000 + 0x200)

// Derived addresses for ZB_AHBADDR_50001000
#define BBCTRL_BASE_50001000     (ZB_AHBADDR_50001000 + 0x000)
#define BBLL_BASE_50001000       (ZB_AHBADDR_50001000 + 0x200)
#define BBPDZB_BASE_50001000     (ZB_AHBADDR_50001000 + 0x300)
#define MODEM_BASE_50001000      (ZB_AHBADDR_50001000 + 0x400)
#define RADIO_BASE_50001000      (ZB_AHBADDR_50001000 + 0x600)
#define DMABB_BASE_50001000      (ZB_AHBADDR_50001000 + 0x800)
#define SCBB_BASE_50001000       (ZB_AHBADDR_50001000 + 0xc00)

// Derived addresses for SPL_AHBADDR_50002000
#define SPLBB_BASE_50002000      (SPL_AHBADDR_50002000 + 0x000)
#define SPLLL_BASE_50002000      (SPL_AHBADDR_50002000 + 0x100)
#define SPLDMA_BASE_50002000     (SPL_AHBADDR_50002000 + 0x200)

///*******************************      baseband dma registers: 0x50425800      ******************************/
#define BB_DMA_BASE_ADDR   0x50425800
...
#define reg_rf_bb_auto_ctrl REG_ADDR8(0x5042590c)
...
#define reg_rf_bb_tx_chn_dep  REG_ADDR8(0x504258f3)
#define reg_rf_bb_tx_size     REG_ADDR8(0x504258f0)
#define reg_rf_bb_tx_size_h   REG_ADDR8(0x504258f1)

#define reg_rf_dma_rx_wptr    REG_ADDR8(0x504258f4)
#define reg_rf_dma_rx_rptr    REG_ADDR8(0x504258f5)

#define reg_rf_dma_tx_rptr(i) REG_ADDR8(0x50425901 + (i << 1))
...
#define reg_rf_dma_tx_wptr(i) REG_ADDR8(0x50425900 + (i << 1))
...
#define reg_rf_dma_tx_rptr1(i) REG_ADDR8(0x50425919 + (i << 1))
#define reg_rf_dma_tx_wptr1(i) REG_ADDR8(0x50425918 + (i << 1))
...
//******************************      RF_Register_list      ******************************/
#define REG_BASEBAND_BASE_ADDR 0x50425000
#define REG_TL_RADIO_BASE_ADDR 0x50425600
...
#define reg_rf_access_code_base_pipe0 0x50425008
#define reg_rf_access_code_base_pipe2 0x50425018
...
#define reg_rf_rxdma_adr   0x50425080
...
#define reg_rf_txdma_adr   0x50425084
...
#define reg_rf_hpm_pos_time_addr           0x50425088
...
#define reg_rf_hpm_neg_time_addr           0x5042508c
...
#define reg_rf_tr_turnaround_pos_time_addr 0x50425090
...
#define reg_rf_tr_turnaround_neg_time_addr 0x50425094
...
#define reg_rf_pa_pup_pos_time_addr        0x50425098
...
#define reg_rf_pa_pup_neg_time_addr        0x5042509c
...
#define reg_rf_en_freq_comp_time_addr      0x504250a0
 ...
 * BB_LL
 */
#define REG_BB_LL_BASE_ADDR 0x50425200
...
#define REG_TL_MODEM_BASE_ADDR      0x50425400
...
#define reg_rf_tx_midx_ble0         REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x9e)
#define reg_rf_tx_midx_ble1         REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x9f)
enum
{
    FLD_RF_TX_MIDX_BLE_H = BIT_RNG(0, 4),
};
...
#define reg_rf_gaim_comp0 REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xd4)
...
#define reg_n22_rst        REG_ADDR16(SCBB_BASE + 0x18)
#define reg_n22_rst0       REG_ADDR8(SCBB_BASE + 0x18)
...
#define reg_n22_rst1 REG_ADDR8(SCBB_BASE + 0x19)

enum
{
    FLD_RST1_RSTL_BB         = BIT(2),
