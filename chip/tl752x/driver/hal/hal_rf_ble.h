...
#ifndef __HAL_RF_BLE_H__
#define __HAL_RF_BLE_H__
...
/**
 * @brief     This function serves to set ble_4M mode of RF.
 * @return    none.
 */
...
{
    write_reg32(0x50425000 + 0x114, 0x555555);
}
...
/**
  ...
  *             Hardware limitation: RF DMA can only access addresses within the MCU B core's DRAM range (0x50080000 ~ 0x5009FFFF).
