 ...
 *  Introduction
 *  ===============
 *  B930 supports two spi:gspi lspi
 *
 *  API Reference
 *  ===============
 *  Header File: spi.h
...
typedef struct
{
    ...
    gpio_func_pin_e spi_io4_pin;
    gpio_func_pin_e spi_io5_pin;
    gpio_func_pin_e spi_io6_pin;
    gpio_func_pin_e spi_io7_pin;
    gpio_func_pin_e spi_dm_pin;
} gspi_pin_config_t;
...
typedef struct
{
    ...
    gpio_func_pin_e gspi_io4_pin;
    gpio_func_pin_e gspi_io5_pin;
    gpio_func_pin_e gspi_io6_pin;
    gpio_func_pin_e gspi_io7_pin;
    gpio_func_pin_e gspi_dm_pin;
