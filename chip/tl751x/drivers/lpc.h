...
{
    analog_write_reg8(0x06, analog_read_reg8(0x07) | 0x04);
}
...
{
    analog_write_reg8(0x06, analog_read_reg8(0x06) & 0xfb);
}
...
{
    analog_write_reg8(0x13, (analog_read_reg8(0x13) & 0x8f) | (pin << 4));
}
...
{
    analog_write_reg8(0x15, (analog_read_reg8(0x15) & 0xfc) | divider);
}
...
{
    return ((analog_read_reg8(0x108) & 0x40) >> 6);
}
