 ...
 * @param[in]  rf_chn      - the channel.(Parameter range:0~80,Frequency range:2400~2480 MHz)
 * @return     none
 */
void rf_emi_tx_single_tone(rf_power_level_e power_level, unsigned char rf_chn);

/**
 * @brief      This function serves to set rx mode and channel
 * @param[in]  mode   - mode of RF.
 * @param[in]  rf_chn - the rx channel.(Parameter range:2~80,Frequency range:2402~2480 MHz)
 * @return     none
 */
void rf_emi_rx_setup(rf_mode_e mode, unsigned char rf_chn);
 ...
 * @param[in]  rf_chn      - channel of RF.(Parameter range:2~80,Frequency range:2402~2480 MHz)
 ...
 * @return     none
 */
void rf_emi_tx_continue_update_data(rf_mode_e rf_mode, rf_power_level_e power_level, unsigned char rf_chn, unsigned char pkt_type);
 ...
 * @return     none
 */
void rf_emi_tx_burst_setup(rf_mode_e rf_mode, rf_power_level_e power_level, unsigned char rf_chn, unsigned char pkt_type);
