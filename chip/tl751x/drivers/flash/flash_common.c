...
/**
   # If add flash type, need pay attention to the read uid command and the bit number of status register.
    ...
    |              | P25Q64SL   |   0x4b  | 0x176085 |  PUYA   |           8us                   |                   25ms               |
    +--------------+------------+---------+----------+---------+---------------------------------+--------------------------------------+
...
const flash_hal_handler_t flash_list[] = {
    ...
    //8M
    {0x176085, flash_get_lock_block_mid176085_with_device_num, flash_unlock_mid176085_with_device_num, flash_lock_mid176085_with_device_num, FLASH_LOCK_LOW_4M_MID176085,   flash_write_status_mid176085_with_device_num, FLASH_WRITE_STATUS_QE_MID176085, FLASH_QE_ENABLE_MID176085, FLASH_QE_DISABLE_MID176085},
