...
unsigned char flash_write_status_mid176085_with_device_num(mspi_slave_device_num_e device_num, unsigned short data, unsigned int mask)
{
    ...
    unsigned short status = flash_read_status_mid176085_with_device_num(device_num);
    if (data != (status & mask)) //To reduce the operation of the status register.
    {
        ...
        status = flash_read_status_mid176085_with_device_num(device_num);
    }
    if (data == (status & mask)) {
        return 1;
    }
...
{
    flash_write_config_mid176085_with_device_num(device_num, 0x00, FLASH_WRITE_CONFIGURE_WPS_MID176085);
    return flash_write_status_mid176085_with_device_num(device_num, data, FLASH_WRITE_STATUS_BP_MID176085);
}
...
{
    flash_write_config_mid176085_with_device_num(device_num, 0x00, FLASH_WRITE_CONFIGURE_WPS_MID176085);
    return flash_write_status_mid176085_with_device_num(device_num, FLASH_LOCK_NONE_MID176085, FLASH_WRITE_STATUS_BP_MID176085);
}
...
{
    return flash_read_status_mid176085_with_device_num(device_num) & FLASH_WRITE_STATUS_BP_MID176085;
}
...
{
    flash_write_status_mid176085_with_device_num(device_num, data, FLASH_WRITE_STATUS_OTP_MID176085);
}
