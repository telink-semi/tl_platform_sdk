...
{
    reg_gpio_func_mux(GPIO_PF0) = reg_gpio_func_mux(GPIO_PF0) & (~BIT_RNG(0, 4));
    reg_gpio_func_mux(GPIO_PF1) = reg_gpio_func_mux(GPIO_PF1) & (~BIT_RNG(0, 4));
    gpio_function_dis((gpio_pin_e)(GPIO_PF0 | GPIO_PF1));
    gpio_input_en((gpio_pin_e)(GPIO_PF0 | GPIO_PF1)); // DP/DM must set input enable
    usb1_dp_pullup_en(1);
}
