 ...
 */
    ...
    FLASH_WRITE_CONFIGURE_CMD_2        = 0x11001080, // Flash Type = P25Q16SU/P25Q32SU/P25Q64SL  for write configure register;
 ...
 * @param[in]   addr    - slave base address + the access address of flash(must be 0 or a multiple of 0x8000).The base address of device0 is 0.
 *                      If there are multiple devices, the base address of other devices is determined by the mspi_slave_device_addr_space_config() function.
 * @return      none.
 * @note        Attention: The block erase takes a long time, please pay attention to feeding the dog in advance.
 *              The maximum block erase time is listed at the beginning of this document and is available for viewing.
 ...
 * @param[in]   addr    - slave base address + the access address of flash(must be 0 or a multiple of 0x10000).The base address of device0 is 0.
 *                      If there are multiple devices, the base address of other devices is determined by the mspi_slave_device_addr_space_config() function.
 * @return      none.
 * @note        Attention: The block erase takes a long time, please pay attention to feeding the dog in advance.
 *              The maximum block erase time is listed at the beginning of this document and is available for viewing.
