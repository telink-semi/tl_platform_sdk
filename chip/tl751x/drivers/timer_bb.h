...
/**
 * @brief     To initialize the Timer_bb module.
 * @param[in] none
 * @return    none
 * @note      Must be placed at the top of other Timer_bb configurations.
 */
static inline void timer_bb_init(void)
{
    reg_n22_rst1 |= FLD_RST0_TIMER_BB;
    reg_n22_clk_en1 |= FLD_CLK0_TIMER_BB;
}
