...
typedef enum {
    ...
    ADC_GPIO_PG6N      = 0x07,
    ADC_GPIO_PF6N      = 0x08,
    ADC_GPIO_PANA0N    = 0x09,
    ADC_GPIO_PANA1N    = 0x0a,
...
typedef enum {
    ...
    ADC_GPIO_PG6P      = 0x07,
    ADC_GPIO_PF6P      = 0x08,
    ADC_GPIO_PANA0P    = 0x09,
    ADC_GPIO_PANA1P    = 0x0a,
...
{
    return ((reg_adc_rxfifo_trig_num & FLD_BUF_CNT));
}
