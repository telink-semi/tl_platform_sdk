...
/*******************************      timer_bb registers: 0x54401000     ******************************/
#define TIMER_BB_BASE_ADDR 0x54401000
...
enum
{
    FLD_TMR_BB0_MODE   = BIT_RNG(0, 1),
    FLD_TMR_BB0_EN     = BIT(2),
    FLD_TMR_BB0_NOWRAP = BIT(3),
    FLD_TMR_BB1_MODE   = BIT_RNG(4, 5),
    FLD_TMR_BB1_EN     = BIT(6),
    FLD_TMR_BB1_NOWRAP = BIT(7),
};
...
enum
{
    FLD_TMR_BB2_MODE   = BIT_RNG(0, 1),
    FLD_TMR_BB2_EN     = BIT(2),
    FLD_TMR_BB2_NOWRAP = BIT(3),
};
