...
#define reg_usb1_pidl         REG_ADDR8(REG_USB1_BASE + 0x06)
#define reg_usb1_pidh         REG_ADDR8(REG_USB1_BASE + 0x07)
#define reg_usb1_edp0_udc_cnt REG_ADDR8(REG_USB1_BASE + 0x08)
...
enum
{
    ...
    FLD_USB1_IRQ_SETINTF_MASK = BIT(7),
};
...
#define reg_usb1_ep_ptrh(i)       REG_ADDR8(REG_USB1_BASE + 0x18 + ((i) & 0x07)) // only ep8/7

#define reg_usb1_ep8_buf_addr     REG_ADDR8(REG_USB1_BASE + 0x20)                // default 0x400
#define reg_usb1_ep1_buf_addr     REG_ADDR8(REG_USB1_BASE + 0x21)                // default 0x000
#define reg_usb1_ep2_buf_addr     REG_ADDR8(REG_USB1_BASE + 0x22)                // default 0x040
#define reg_usb1_ep3_buf_addr     REG_ADDR8(REG_USB1_BASE + 0x23)                // default 0x080
#define reg_usb1_ep4_buf_addr     REG_ADDR8(REG_USB1_BASE + 0x24)                // default 0x0c0
#define reg_usb1_ep5_buf_addr     REG_ADDR8(REG_USB1_BASE + 0x25)                // default 0x100
#define reg_usb1_ep6_buf_addr     REG_ADDR8(REG_USB1_BASE + 0x26)                // default 0x140
#define reg_usb1_ep7_buf_addr     REG_ADDR8(REG_USB1_BASE + 0x27)                // default 0x180
...
#define reg_usb1_ep_buf_h_addr(i) REG_ADDR8(REG_USB1_BASE + 0x28 + ((i) & 0x07)) // only ep8/7
...
#define reg_usb1_ep8_min1   REG_ADDR8(REG_USB1_BASE + 0x61)
...
#define reg_usb1_edps_sptr  REG_ADDR16(REG_USB1_BASE + 0x68)

#define reg_usb1_edps_maxh  REG_ADDR8(REG_USB1_BASE + 0x6a)
